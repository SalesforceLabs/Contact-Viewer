...
($j("#detailpage").hide(),$j("#listpage").show().css("visibility",""),a());updateLastVisitLoc()});b.hide();"function"==typeof c&&c()});updateLastVisitLoc(a+"/info")}

...
function addClickListeners(){$j("#listpage #header #gear").unbind().touch(function(a){a.preventDefault();SettingsManager.show()})}
function showContact(a,c){$j("#detailpage #detail").hide();$j("#detailpage .header>span").empty();switchToDetail();var b=$j("#loggedin").showActivityInd("Loading...");switchDetailSection("info",[a],function(a){a&&$j("#detailpage #detail").show();$j("#detailpage .header #left").unbind().click(function(){var a=function(){$j("#detailpage").css("visibility","hidden");listView.resetSelectedContact()};$j("#detailpage .header #left").unbind();useAnimations?$j("#detailpage").changePage("#listpage",

...
function switchDetailSection(a,c,b){var d=Date.now();$j("#detailpage #contactInfo").show();$j("#detailpage #detail>span>div").hide();var e=function(c){LocalyticsManager.tagDetailView(a,Date.now()-d);"function"==typeof b&&b(c)};if("info"==a)return renderContactInfo(c[0],function(a){a&&$j("#detailpage #detail #infoscroller").show();e(a)});e();updateLastVisitLoc(c[0]+"/"+a)};
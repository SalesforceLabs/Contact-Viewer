...
function switchToDetail(a){useAnimations?$j("#detailpage").slideInLeft(function(){switch(isPortrait()){case !1:$j("#detailpage").css(vendor+"Transform","none")}}):$j("#detailpage").show().css("visibility","");"function"==typeof a&&a()}

...
destroyFeedScroller()):($j("#rightsection #detailpage #detail #feedscroller").show(),destroyInfoScroller());var f=function(c){LocalyticsManager.tagDetailView(a,Date.now()-d);typeof b=="function"&&b(c)},e=function(){$j("#rightsection #detailpage #detail #feedscroller").css("visibility","");initiateFeedScroller();f()};"info"==a?renderContactInfo(c[0],function(a){a&&$j("#rightsection #detailpage #detail #infoscroller").css("visibility","");f(a)}):"chatter"==a?getChatter(c[0],e):"salesforce"==a?getActivities(c[0],
e):"rss"==a?getAggregateFeed([c[0]],e):f();updateLastVisitLoc(c[0]+"/"+a)}function codeAddressOnMap(a){var c=encodeURI(a);$j("#map_section #map_div #google_map_canvas").empty().append('<img src="https://maps.googleapis.com/maps/api/staticmap?zoom=14&size=640x180&format=jpeg&sensor=false&markers=color:red%7C'+c+'"/>');$j("#map_section #map_div #openMaps").off().enableTap().click(function(){window.location=("undefined"!=typeof PhoneGap&&PhoneGap?"maps:q=":"https://maps.google.com/maps?q=")+c})};
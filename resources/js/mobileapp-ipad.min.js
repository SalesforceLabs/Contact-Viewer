...
var login_redirect_storage_key="SFDC-LOGIN-REDIRECT",feedpagescroll,infopagescroll,hasRecordTypes=!1,hasChatterEnabled=!1,contactLabel="Contact",contactPluralLabel="Contacts",listView,splitView,sobjectModel;function initiateInfoScroller(){void 0===infopagescroll?(infopagescroll=createScroller("infoscroller",null,{onBeforeScrollStart:function(){}}),$j(window).orientationChange(initiateInfoScroller)):infopagescroll.refresh();destroyFeedScroller()}
function destroyInfoScroller(){infopagescroll&&($j(window).unbindOrientationChange(initiateInfoScroller),infopagescroll.destroy(),infopagescroll=void 0)}function initiateFeedScroller(){void 0===feedpagescroll?(feedpagescroll=createScroller("feedscroller",null,{onBeforeScrollStart:function(){}}),$j(window).orientationChange(initiateFeedScroller)):feedpagescroll.refresh();destroyInfoScroller()}
...
f):d();updateLastVisitLoc(c[0]+"/"+a)}function codeAddressOnMap(a){var c=encodeURI(a);$j("#map_section #map_div #google_map_canvas").empty().append('<img src="http://maps.googleapis.com/maps/api/staticmap?zoom=14&size=640x180&format=jpeg&sensor=false&markers=color:red%7C'+c+'"/>');$j("#map_section #map_div #openMaps").unbind().click(function(){window.location=("undefined"!=typeof PhoneGap&&PhoneGap?"maps:q=":"https://maps.google.com/maps?q=")+c})};
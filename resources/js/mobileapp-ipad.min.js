...
"");initiateFeedScroller();b&&b.hide();"function"==typeof a&&a()},{includeParent:!0,onClickParent:function(a){this.id.startsWith("contact_")&&(a.preventDefault(),listView.selectContact(this.id.substring(8)))}})}
...
f):d();updateLastVisitLoc(c[0]+"/"+a)}function codeAddressOnMap(a){$j("#map_section #map_div #google_map_canvas").empty().append('<img src="http://maps.googleapis.com/maps/api/staticmap?zoom=14&size=640x180&format=jpeg&sensor=false&markers=color:red%7C'+a+'"/>');$j("#map_section #map_div #openMaps").unbind().click(function(){window.location=("undefined"!=typeof PhoneGap&&PhoneGap?"maps:q=":"https://maps.google.com/maps?q=")+a})};
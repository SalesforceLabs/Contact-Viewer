...
function showContact(a,c){addLeftNavClickListeners([a]);splitView.focusOutContactList();$j("#rightsection #detailpage #detail").css("visibility","hidden").css("opacity","0");$j("#detailpage .header>span").empty();switchToDetail();var b=$j("#rightsection").showActivityInd("Loading...");switchDetailSection("info",[a],function(a){a&&$j("#rightsection #detailpage #detail").css("visibility","").css("opacity","1");b.hide();"function"==typeof c&&c()});updateLastVisitLoc(a+"/info")}

...
localStorage.removeItem(a)},setSessionValue:function(a,b){this.checkSessionStorage()&&sessionStorage.setItem(a,b)},getSessionValue:function(a){if(this.checkSessionStorage())return sessionStorage.getItem(a)},clearSessionValue:function(a){this.checkSessionStorage()&&sessionStorage.removeItem(a)}}}();function saveUserPic(){navigator.camera.getPicture(onPicSuccess,onPicFail,{quality:50})}
...
function onPicFail(a){console.log("Pic Failed because: "+a)}$j(function(){$j("#photo_div img").enableTap().click(saveUserPic);if(typeof sforce.Client!="undefined")sforce.Client.prototype.addAttachment=function(a,b,d,c,e,f){var g=getBaseUrl()+"/services/apexrest/cvapi?action=insertSObject&sobject=Attachment";this.ajax("POST",g,{Name:a,ParentId:b,Body:d},c,e,f)}});
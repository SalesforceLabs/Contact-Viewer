...
void 0===sforce.Client&&(sforce.Client=function(a){this.sessionHeader=null;this.SESSION_HEADER="App-Session";this.retryHandler=function(b,c){return function(d,e){switch(d.status){case 401:if("function"==typeof a){a(b);break}default:c(d,e)}}}},sforce.Client.prototype.ajax=function(a,b,c,d,e,f,h){var g=this;$j.ajax({type:a,url:b,processData:!0,data:c,dataType:"json",success:d,error:h?e:g.retryHandler(function(){g.ajax(a,b,c,d,e,f,!0)},e),complete:f,beforeSend:function(a){g.sessionHeader&&a.setRequestHeader(g.SESSION_HEADER,
g.sessionHeader)}})},sforce.Client.prototype.setSessionHeader=function(a){this.sessionHeader=a},sforce.Client.prototype.getAuthorizeUrl=function(a){return getBaseUrl()+"/services/apexrest/oauth2/?doAuthorize&host="+a},sforce.Client.prototype.refreshAccessToken=function(a,b,c,d,e,f){var h=getBaseUrl()+"/services/apexrest/oauth2/refreshAccess";this.ajax("POST",h,"rt="+c+"&pass="+a+"&cid="+b,d,e,f)},sforce.Client.prototype.obtainAccessToken=function(a,b,c,d,e,f){var h=getBaseUrl()+"/services/apexrest/oauth2/authenticate";
this.ajax("POST",h,"code="+b+(c?"&pass="+c:"")+(a?"&host="+a:""),d,e,f)},sforce.Client.prototype.prepareSession=function(a,b,c){var d=getBaseUrl()+"/services/apexrest/oauth2/prepareSession";this.ajax("POST",d,null,a,b,c)},sforce.Client.prototype.prepareSessionFromOAuth=function(a,b,c,d,e,f){var h=getBaseUrl()+"/services/apexrest/oauth2/prepareSession";this.sessionHeader=null;this.ajax("POST",h,"accessToken="+a+"&instanceUrl="+b+"&identityUrl="+c,d,e,f)},sforce.Client.prototype.revokeSession=function(a,
b,c,d,e){var f=getBaseUrl()+"/services/apexrest/oauth2/revokeSession";this.ajax("POST",f,a&&b?"cid="+a+"&rt="+b:"",c,d,e)},sforce.Client.prototype.queryContactsViaApex=function(a,b,c,d){var e=getBaseUrl()+"/services/apexrest/cvapi";this.ajax("GET",e,"action=fetchContacts&filter="+a,b,c,d)},sforce.Client.prototype.retrieveContactViaApex=function(a,b,c,d,e){var f=getBaseUrl()+"/services/apexrest/cvapi";this.ajax("GET",f,"action=retrieveContact&id="+a+"&fields="+b,c,d,e)},sforce.Client.prototype.searchContactsViaApex=
function(a,b,c,d){var e=getBaseUrl()+"/services/apexrest/cvapi";this.ajax("GET",e,"action=searchContacts&text="+a,b,c,d)},sforce.Client.prototype.fetchChatterViaApex=function(a,b,c,d){var e=getBaseUrl()+"/services/apexrest/cvapi";this.ajax("GET",e,"action=fetchChatter&ids="+a,b,c,d)},sforce.Client.prototype.fetchActivitiesViaApex=function(a,b,c,d){var e=getBaseUrl()+"/services/apexrest/cvapi";this.ajax("GET",e,"action=fetchActivities&ids="+a,b,c,d)},sforce.Client.prototype.getUsersInfoViaApex=function(a,
b,c,d,e){var f=getBaseUrl()+"/services/apexrest/cvapi";this.ajax("GET",f,"action=getUsersInfo&id="+a+"&fetchPhotos="+b,c,d,e)},sforce.Client.prototype.describeContactViaApex=function(a,b,c){var d=getBaseUrl()+"/services/apexrest/cvapi";this.ajax("GET",d,"action=describeContact",a,b,c)},sforce.Client.prototype.getContactDetailsViaApex=function(a,b,c,d,e,f){var h=this,g=getBaseUrl()+"/ContactDetails",j=(new Date).getTimezoneOffset();$j.ajax({type:"GET",url:g,data:"id="+a+"&rtid="+(b||"")+"&tzOffset="+
j,success:c,error:f?d:h.retryHandler(function(){h.getContactDetailsViaApex(a,b,c,d,e,!0)},d),complete:e,beforeSend:function(a){h.sessionHeader&&a.setRequestHeader(h.SESSION_HEADER,h.sessionHeader)}})},sforce.Client.prototype.getContactAppEula=function(a,b,c){var d=getBaseUrl()+"/ContactsAppEula";$j.ajax({type:"GET",url:d,success:a,error:b,complete:c})},sforce.Client.prototype.submitEulaResponse=function(a,b,c,d,e){var f=getBaseUrl()+"/services/apexrest/cvapi";this.ajax("GET",f,"action=manageEula&clientId="+
a+"&eulaResponse="+b,c,d,e)});
var SettingsManager=function(){function a(c){if(c&&e!=c){d&&g();d=createScroller(b.find(".settings_body "+c));e=c;$j(window).orientationChange(function(){a()})}else d&&d.refresh()}var b,c,d,e,f,h=false,g=function(){if(d){d.destroy();e=d=void 0}},j=function(){var a=ManageUserSession.getLoginHostType();if(!a){a=b.find("#hosts table td")[0].id;ManageUserSession.setLoginHostType(a)}if(a){b.find("#connection #hostType #name").text(b.find("#hosts #"+a+" span").text());b.find("#hosts table td").css("color","black");
b.find("#hosts #"+a).css("color","#395483").append(b.find("#hosts #check"))}b.find("#main #connection #host_url input").val(ManageUserSession.getLoginHostUrl())},l=function(c,d){ManageUserSession.getApiClient().getContactAppEula(function(a){a=$j(a);a.find("head, script").remove();b.find("#eula .content").empty().append(a);if(c){a=b.find("#eula_buttons").show();b.find("#eula").css("margin-bottom",a.outerHeight()+"px")}else b.find("#eula").css("margin-bottom","0")},errorCallback,function(b,c){a("#eula");
typeof d=="function"&&d(c)})},k=function(c,d,e,f){var g=$j(this),j;h&&setTimeout(function(){b.find("#main #connection #host_url input").blur()},10);g.addClass("cellselected");b.find("#header #done").hide();j=function(){g.removeClass("cellselected");b.find("#main").css("visibility","hidden");typeof f=="function"&&f()};if(useAnimations)b.find("#main").changePage(b.find(c),false,j);else{b.find("#main").hide();b.find(c).show().css("visibility","");j()}b.find("#header #title").text(d);a(c);if(e){var m=
b.find(c);b.find("#header #left").show().touch(function(){b.find("#header #left").hide().off();if(useAnimations)m.changePage(b.find("#main"),true,function(){m.css("visibility","hidden")});else{m.hide();b.find("#main").show().css("visibility","")}b.find("#header #title").text("Settings");ManageUserSession.isActive()&&b.find("#header #done").show();a("#main")})}},m=function(){b.positionCenterOf(window)};return{show:function(){var d,e;if(!c){c=true;b=$j("#app_settings");b.find("#main #connection #hostType").enableTap().click(function(){k("#hosts",

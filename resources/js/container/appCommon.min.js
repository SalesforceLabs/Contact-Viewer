...
typeof d=="function"&&d(c)})},k=function(c,d,e,f){var h=$j(this),j;g&&setTimeout(function(){b.find("#main #connection #host_url input").blur()},10);h.addClass("cellselected");b.find("#header #done").hide();j=function(){h.removeClass("cellselected");b.find("#main").css("visibility","hidden");typeof f=="function"&&f()};if(useAnimations)b.find("#main").changePage(b.find(c),false,j);else{b.find("#main").hide();b.find(c).show().css("visibility","");j()}b.find("#header #title").text(d);a(c);if(e){var k=
b.find(c);b.find("#header #left").show().touch(function(){b.find("#header #left").hide().off();if(useAnimations)k.changePage(b.find("#main"),true,function(){k.css("visibility","hidden")});else{k.hide();b.find("#main").show().css("visibility","")}b.find("#header #title").text("Settings");ManageUserSession.isActive()&&b.find("#header #done").show();a("#main")})}},m=function(){b.positionCenterOf(window)};return{show:function(){var d,e;if(!c){c=true;b=$j("#app_settings");b.find("#main #connection #hostType").enableTap().click(function(){k("#hosts",
...
var ManageUserSession=function(){function a(a){var e,h,j,l;e=$j(document).showActivityInd("Authenticating...",false);h=new OAuthProperties(remoteAccessConsumerKey,oauthRedirectURI,["api"],true,true);j=function(a){var f=function(f){if(f.success){c=true;d=f.username;b.setSessionHeader(f.sessionToken);e.hide();typeof a=="function"&&a()}else l()};return function(a){b.prepareSessionFromOAuth(a.accessToken,a.instanceUrl,a.identityUrl,f,l)}};l=function(b){SFHybridApp.logError("loginFailure: "+b);e.hide();
confirm("Authentication failed. Do you want to retry?")&&ManageUserSession.initialize(a)};SalesforceOAuthPlugin.authenticate(j(a),l,h);$j(document).off("salesforceSessionRefresh").on("salesforceSessionRefresh",function(a){j()(a.originalEvent.data)})}var b,c,d,e;return{isActive:function(){return c==true},isEulaAccepted:function(){return true},updateEula:function(){},getUsername:function(){return c?d:null},getApiClient:function(){return c?b:null},getLoginHostType:function(){return e.toLowerCase().indexOf("login.")==

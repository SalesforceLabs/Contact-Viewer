...
this,h=getBaseUrl()+"/ContactDetails",j=(new Date).getTimezoneOffset(),k=!1;$j.ajax({type:"GET",url:h,data:"id="+a+"&rtid="+(b||"")+"&tzOffset="+j,success:c,error:f?d:g.retryHandler(function(){g.getContactDetailsViaApex(a,b,c,d,e,!0)},d),complete:function(a,b){"function"==typeof e&&(f||k)&&e(a,b)},beforeSend:function(a){g.sessionHeader&&a.setRequestHeader(g.SESSION_HEADER,g.sessionHeader)}}).success(function(){k=!0})},sforce.Client.prototype.getContactAppEula=function(a,b,c){var d=getBaseUrl()+"/ContactsAppEula";
$j.ajax({type:"GET",url:d,success:a,error:b,complete:c})},sforce.Client.prototype.submitEulaResponse=function(a,b,c,d,e){var f=getBaseUrl()+"/services/apexrest/cvapi";this.ajax("GET",f,"action=manageEula&clientId="+a+"&eulaResponse="+b,c,d,e)});
...
if(e){var m=b.find(c);b.find("#header #left").show().touch(function(){b.find("#header #left").hide().off();if(useAnimations)m.changePage(b.find("#main"),true,function(){m.css("visibility","hidden")});else{m.hide();b.find("#main").show().css("visibility","")}b.find("#header #title").text("Settings");ManageUserSession.isActive()&&b.find("#header #done").show();a("#main")})}},m=function(){b.positionCenterOf(window)};return{show:function(){var d,e;if(!c){c=true;b=$j("#app_settings");b.find("#main #connection #hostType").enableTap().click(function(){l("#hosts",
...
var ManageUserSession=function(){function a(e,g){var h,j,k,l;g&&(h=$j(document).showActivityInd("Authenticating...",false));j=new OAuthProperties(remoteAccessConsumerKey,oauthRedirectURI,["api"],false,false);l=function(b){return function(){h&&h.hide();confirm("Authentication failed. Do you want to retry?")&&a(b)}};k=function(a){var e=l(a),f=function(f){if(f.success){c=true;d=f.username;b.setSessionHeader(f.sessionToken);h&&h.hide();typeof a=="function"&&a()}else e()};return function(a){b.prepareSessionFromOAuth(a.accessToken,
a.instanceUrl,a.identityUrl,f,e)}};SalesforceOAuthPlugin.authenticate(k(e),l(e),j);$j(document).off("salesforceSessionRefresh").on("salesforceSessionRefresh",function(a){k()(a.originalEvent.data)})}var b,c,d,e;return{isActive:function(){return c==true},isEulaAccepted:function(){return true},updateEula:function(){},getUsername:function(){return c?d:null},getApiClient:function(){return c?b:null},getLoginHostType:function(){return e.toLowerCase().indexOf("login.")==0?"host_production":e.toLowerCase().indexOf("test.")==

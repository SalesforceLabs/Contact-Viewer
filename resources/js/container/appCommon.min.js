...
c){a("#eula");typeof d=="function"&&d(c)})},k=function(c,d,e,f){var g=$j(this),j;h&&setTimeout(function(){b.find("#main #connection #host_url input").blur()},10);g.addClass("cellselected");b.find("#header #done").hide();j=function(){g.removeClass("cellselected");b.find("#main").css("visibility","hidden");typeof f=="function"&&f()};if(useAnimations)b.find("#main").changePage(b.find(c),false,j);else{b.find("#main").hide();b.find(c).show().css("visibility","");j()}b.find("#header #title").text(d);a(c);
if(e){var m=b.find(c);b.find("#header #left").show().touch(function(){b.find("#header #left").hide().off();if(useAnimations)m.changePage(b.find("#main"),true,function(){m.css("visibility","hidden")});else{m.hide();b.find("#main").show().css("visibility","")}b.find("#header #title").text("Settings");ManageUserSession.isActive()&&b.find("#header #done").show();a("#main")})}},m=function(){b.positionCenterOf(window)};return{show:function(){var d,e;if(!c){c=true;b=$j("#app_settings");b.find("#main #connection #hostType").enableTap().click(function(){k("#hosts",
...
b.find("#main #connection #host_url form").submit(function(){var a=b.find("#main #connection #host_url input"),c=b.find("#main #connection #host_url input").val().trim();(c=c.length==0||c.endsWith(".salesforce.com"))||alert('Custom host url must end with ".salesforce.com".');if(c){ManageUserSession.setLoginHostUrl(a.val());j();a.blur()}return false});b.find("#main #help #help_about").enableTap().click(function(){k("#about","About",true,void 0)});b.find("#main #help #help_faq").enableTap().click(function(){k("#faq",
"FAQ",true,function(){})});b.find("#main #help #help_eula").enableTap().click(function(){k("#eula","Contact Viewer EULA",true,l)});b.find("#loginbtn").off().enableTap().click(function(){prepareSession()});b.find("#logoutbtn").off().enableTap().click(function(){confirm("Logout user "+ManageUserSession.getUsername()+"?")&&logout(false)})}j();b.find("#header #title").text("Settings");b.find(".page").css("visibility","hidden");b.find("#main").css("visibility","visible");b.width()<500&&b.find("#header #left>div").text("Back");
...
var ManageUserSession=function(){function a(e,h){var g,j,l,k;h&&(g=$j(document).showActivityInd("Authenticating...",false));j=new OAuthProperties(remoteAccessConsumerKey,oauthRedirectURI,["api"],false,false);k=function(b){return function(){g&&g.hide();confirm("Authentication failed. Do you want to retry?")&&a(b)}};l=function(a){var e=k(a),f=function(f){if(f.success){c=true;d=f.username;b.setSessionHeader(f.sessionToken);g&&g.hide();typeof a=="function"&&a()}else e()};return function(a){b.prepareSessionFromOAuth(a.accessToken,
a.instanceUrl,a.identityUrl,f,e)}};SalesforceOAuthPlugin.authenticate(l(e),k(e),j);$j(document).off("salesforceSessionRefresh").on("salesforceSessionRefresh",function(a){l()(a.originalEvent.data)})}var b,c,d,e;return{isActive:function(){return c==true},isEulaAccepted:function(){return true},updateEula:function(){},getUsername:function(){return c?d:null},getApiClient:function(){return c?b:null},getLoginHostType:function(){return e.toLowerCase().indexOf("login.")==0?"host_production":e.toLowerCase().indexOf("test.")==

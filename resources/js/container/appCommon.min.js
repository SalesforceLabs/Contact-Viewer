...
f);h&&(j.onScrollEnd=h);return new iScroll(a[0],j)}
...
function prepareSession(a){"false"==StorageManager.getSessionValue(login_redirect_storage_key)?(StorageManager.clearSessionValue(login_redirect_storage_key),setTimeout(SettingsManager.show,10)):(LocalyticsManager.logAppStarted(),ManageUserSession.initialize(function(){LocalyticsManager.logAuthComplete();ManageUserSession.isEulaAccepted()?sessionCallback():getEulaResponse(sessionCallback)},a))}
void 0===sforce.Client&&(sforce.Client=function(a){this.sessionHeader=null;this.SESSION_HEADER="App-Session";this.errorHandler=function(b,c){return function(d,e){if("abort"!=e)switch(d.status){case 401:if(b.allowRetry&&"function"==typeof a){b.retryingRequest=!0;a(function(){b.replay()});break}default:b.allowRetry=!1,"function"==typeof c&&c(d,e)}}}},sforce.Client.RequestManager=function(a,b){this.xhr=a;this.allowRetry=b||!0},sforce.Client.RequestManager.prototype.abort=function(){this.allowRetry=!1;
"pending"==this.xhr.state()?this.xhr.abort():this.retryingRequest&&this.settings.complete(this.xhr,"abort");this.retryingRequest=!1},sforce.Client.RequestManager.prototype.replay=function(){this.allowRetry&&(this.allowRetry=!1,this.xhr=$j.ajax(this.settings))},sforce.Client.prototype.ajax=function(a,b,c,d,e,f,h){var g=this,j=new sforce.Client.RequestManager;j.xhr=$j.ajax({type:a,url:b,processData:!0,data:c,dataType:d,success:e,error:g.errorHandler(j,f),beforeSend:function(a,b){j.settings=b;g.sessionHeader&&
a.setRequestHeader(g.SESSION_HEADER,g.sessionHeader)},complete:function(a,b){"function"==typeof h&&(!j.allowRetry||!j.retryingRequest)&&h(a,b)}});return j},sforce.Client.prototype.getJSON=function(a,b,c,d,e,f){return this.ajax(a,b,c,"json",d,e,f)},sforce.Client.prototype.setSessionHeader=function(a){this.sessionHeader=a},sforce.Client.prototype.getAuthorizeUrl=function(a){return getBaseUrl()+"/services/apexrest/oauth2/?doAuthorize&host="+a},sforce.Client.prototype.refreshAccessToken=function(a,b,
c,d,e,f){var h=getBaseUrl()+"/services/apexrest/oauth2/refreshAccess";return this.getJSON("POST",h,"rt="+c+"&pass="+a+"&cid="+b,d,e,f)},sforce.Client.prototype.obtainAccessToken=function(a,b,c,d,e,f){var h=getBaseUrl()+"/services/apexrest/oauth2/authenticate";return this.getJSON("POST",h,"code="+b+(c?"&pass="+c:"")+(a?"&host="+a:""),d,e,f)},sforce.Client.prototype.prepareSession=function(a,b,c){var d=getBaseUrl()+"/services/apexrest/oauth2/prepareSession";return this.getJSON("POST",d,null,a,b,c)},
sforce.Client.prototype.prepareSessionFromOAuth=function(a,b,c,d,e,f){var h=getBaseUrl()+"/services/apexrest/oauth2/prepareSession";this.sessionHeader=null;return this.getJSON("POST",h,"accessToken="+a+"&instanceUrl="+b+"&identityUrl="+c,d,e,f)},sforce.Client.prototype.revokeSession=function(a,b,c,d,e){var f=getBaseUrl()+"/services/apexrest/oauth2/revokeSession";return this.getJSON("POST",f,a&&b?"cid="+a+"&rt="+b:"",c,d,e)},sforce.Client.prototype.queryContactsViaApex=function(a,b,c,d){var e=getBaseUrl()+
"/services/apexrest/cvapi";return this.getJSON("GET",e,"action=fetchContacts&filter="+a,b,c,d)},sforce.Client.prototype.retrieveContactViaApex=function(a,b,c,d,e){var f=getBaseUrl()+"/services/apexrest/cvapi";return this.getJSON("GET",f,"action=retrieveContact&id="+a+"&fields="+b,c,d,e)},sforce.Client.prototype.searchContactsViaApex=function(a,b,c,d){var e=getBaseUrl()+"/services/apexrest/cvapi";return this.getJSON("GET",e,"action=searchContacts&text="+a,b,c,d)},sforce.Client.prototype.fetchChatterViaApex=
function(a,b,c,d){var e=getBaseUrl()+"/services/apexrest/cvapi";return this.getJSON("GET",e,"action=fetchChatter&ids="+a,b,c,d)},sforce.Client.prototype.fetchActivitiesViaApex=function(a,b,c,d){var e=getBaseUrl()+"/services/apexrest/cvapi";return this.getJSON("GET",e,"action=fetchActivities&ids="+a,b,c,d)},sforce.Client.prototype.getUsersInfoViaApex=function(a,b,c,d,e){var f=getBaseUrl()+"/services/apexrest/cvapi";return this.getJSON("GET",f,"action=getUsersInfo&id="+a+"&fetchPhotos="+b,c,d,e)},sforce.Client.prototype.describeContactViaApex=
function(a,b,c){var d=getBaseUrl()+"/services/apexrest/cvapi";return this.getJSON("GET",d,"action=describeContact",a,b,c)},sforce.Client.prototype.getContactDetailsViaApex=function(a,b,c,d,e){var f=getBaseUrl()+"/ContactDetails",h=(new Date).getTimezoneOffset();return this.ajax("GET",f,"id="+a+"&rtid="+(b||"")+"&tzOffset="+h,"html",c,d,e)},sforce.Client.prototype.getContactAppEula=function(a,b,c){var d=getBaseUrl()+"/ContactsAppEula";return this.ajax("GET",d,null,"html",a,b,c)},sforce.Client.prototype.submitEulaResponse=
function(a,b,c,d,e){var f=getBaseUrl()+"/services/apexrest/cvapi";return this.getJSON("GET",f,"action=manageEula&clientId="+a+"&eulaResponse="+b,c,d,e)});
var SettingsManager=function(){function a(c){if(c&&e!=c){d&&g();d=createScroller(b.find(".settings_body "+c));e=c;$j(window).orientationChange(function(){a()})}else d&&d.refresh()}var b,c,d,e,f,h=false,g=function(){if(d){d.destroy();e=d=void 0}},j=function(){var a=ManageUserSession.getLoginHostType();if(!a){a=b.find("#hosts table td")[0].id;ManageUserSession.setLoginHostType(a)}if(a){b.find("#connection #hostType #name").text(b.find("#hosts #"+a+" span").text());b.find("#hosts table td").css("color",
"black");b.find("#hosts #"+a).css("color","#395483").append(b.find("#hosts #check"))}b.find("#main #connection #host_url input").val(ManageUserSession.getLoginHostUrl())},l=function(c,d){ManageUserSession.getApiClient().getContactAppEula(function(a){a=$j(a);a.find("head, script").remove();b.find("#eula .content").empty().append(a);if(c){a=b.find("#eula_buttons").show();b.find("#eula").css("margin-bottom",a.outerHeight()+"px")}else b.find("#eula").css("margin-bottom","0")},errorCallback,function(b,
c){a("#eula");typeof d=="function"&&d(c)})},m=function(c,d,e,f){var g=$j(this),j;h&&setTimeout(function(){b.find("#main #connection #host_url input").blur()},10);g.addClass("cellselected");b.find("#header #done").hide();j=function(){g.removeClass("cellselected");b.find("#main").css("visibility","hidden");typeof f=="function"&&f()};if(useAnimations)b.find("#main").changePage(b.find(c),false,j);else{b.find("#main").hide();b.find(c).show().css("visibility","");j()}b.find("#header #title").text(d);a(c);
if(e){var k=b.find(c);b.find("#header #left").show().touch(function(){b.find("#header #left").hide().off();if(useAnimations)k.changePage(b.find("#main"),true,function(){k.css("visibility","hidden")});else{k.hide();b.find("#main").show().css("visibility","")}b.find("#header #title").text("Settings");ManageUserSession.isActive()&&b.find("#header #done").show();a("#main")})}},k=function(a,b,c){m(a,b,true,c);LocalyticsManager.tagScreen(b)},n=function(){b.positionCenterOf(window)};return{show:function(){var d,
e;if(!c){c=true;b=$j("#app_settings");b.find("#main #connection #hostType").click(function(){k("#hosts","Login Host")});b.find("#hosts table td").click(function(){var a=$j(this);a.addClass("cellselected");ManageUserSession.setLoginHostType(this.id);j();setTimeout(function(){a.removeClass("cellselected")},100)});b.find("#main #connection #host_url input").focus(function(){h=true;$j(this).css("text-align","left")}).blur(function(){h=false;$j(this).val(ManageUserSession.getLoginHostUrl());$j(this).css("text-align",
"right");setTimeout(function(){$j(document.body).scrollTop(0)},10)});b.find("#main #connection #host_url form").submit(function(){var a=b.find("#main #connection #host_url input"),c=b.find("#main #connection #host_url input").val().trim();(c=c.length==0||c.endsWith(".salesforce.com"))||alert('Custom host url must end with ".salesforce.com".');if(c){ManageUserSession.setLoginHostUrl(a.val());j();a.blur()}return false});b.find("#main #help #help_about").click(function(){k("#about","About")});b.find("#main #help #help_faq").click(function(){k("#faq",
"FAQ",function(){})});b.find("#main #help #help_feedback").click(function(){location.href="mailto:"+feedbackEmail});b.find("#main #help #help_eula").click(function(){k("#eula","Contact Viewer EULA",l)});b.find("#loginbtn").off().click(function(){prepareSession()});b.find("#logoutbtn").off().click(function(){confirm("Logout user "+ManageUserSession.getUsername()+"?")&&logout(false)})}j();b.find("#header #title").text("Settings");b.find(".page").css("visibility","hidden");b.find("#main").css("visibility",
"visible");b.width()<500&&b.find("#header #left>div").text("Back");if(ManageUserSession.isActive()){b.find("#header #done").show();b.find("#loginbtn").hide();b.find("#logoutbtn").show()}else{b.find("#loginbtn").show();b.find("#logoutbtn").hide()}f=$j("#loggedin").addOverlay();b.find("#username").setText(ManageUserSession.getUsername()||"None");b.find("#header #done").off("click").enableTap().click(function(){SettingsManager.hide();$j(this).off("click");if(!ManageUserSession.isActive())window.location=
getBaseUrl()});ManageUserSession.isActive()||b.find("#header #done").hide();d=window.innerHeight;e=(window.innerHeight-b.height())/2;b.hide().css("zIndex",$j.topZIndex(f.elem)+10).css({left:(window.innerWidth-b.width())/2});useAnimations?b.css({top:0}).show().slideIn("Y",d,e):b.css({top:e}).show();a("#main");b.orientationChange(n);LocalyticsManager.tagScreen("Settings")},hide:function(a){var c=window.innerHeight,d=function(){b.hide();f.hide();typeof a=="function"&&a()};useAnimations?b.slideOut("Y",
c,d):d();g();b.unbindOrientationChange(n)},showEula:function(a,c){SettingsManager.show();m("#eula","End User License Agreement",false,function(){l(true);var d=b.find("#eula_buttons").show();d.find("#accept").off().enableTap().click(a);d.find("#decline").off().enableTap().click(c)});LocalyticsManager.tagScreen("EULA Request")},hideEula:function(){SettingsManager.hide(function(){if(useAnimations)b.find("#eula").changePage(b.find("#main"),true);else{b.find("#eula").hide();b.find("#main").show().css("visibility",
"")}b.find("#eula").css("visibility","hidden");b.find("#eula_buttons").hide();b.find("#header #title").text("Settings")})}}}(),FeedPhotoRenderer=function(){this.userIds=[]};FeedPhotoRenderer.prototype.getImage=function(a){this.userIds.push(a);return'<img class="feedImage app-images" id="photo__'+escape(a)+'"/>'};
...
function(a){var c=a.target;if(c.nodeType==3)c=c.parentNode;var e=$j("#listpage");($j(c).is(e)||e.has(c).length>0)&&a.preventDefault();b(d);return true},true)})}});a.view.find("#listscroller #scroller #contactlist").off().click(function(b){var d=b.target;if(!a.loadingItem){d=$j(d).closest("li",a.view);b.preventDefault();d.length&&(!d.hasClass("listseparater")&&typeof a.options.onItemSelect=="function")&&a.selectContact(d[0].id.substring(8))}})},_addSearchListeners:function(){var a=this,b=function(){var a=
...
var ManageUserSession=function(){function a(e,h){var g,j,l,m;h&&(g=$j(document).showActivityInd("Authenticating...",false));j=new OAuthProperties(remoteAccessConsumerKey,oauthRedirectURI,["api"],false,false);m=function(b){return function(){g&&g.hide();confirm("Authentication failed. Do you want to retry?")&&a(b)}};l=function(a){var e=m(a),f=function(f){if(f.success){c=true;d=f.username;b.setSessionHeader(f.sessionToken);g&&g.hide();typeof a=="function"&&a()}else e()};return function(a){b.prepareSessionFromOAuth(a.accessToken,
a.instanceUrl,a.identityUrl,f,e)}};SalesforceOAuthPlugin.authenticate(l(e),m(e),j);$j(document).off("salesforceSessionRefresh").on("salesforceSessionRefresh",function(a){l()(a.originalEvent.data)})}var b,c,d,e;return{isActive:function(){return c==true},isEulaAccepted:function(){return true},updateEula:function(){},getUsername:function(){return c?d:null},getApiClient:function(){return c?b:null},getLoginHostType:function(){return e.toLowerCase().indexOf("login.")==0?"host_production":e.toLowerCase().indexOf("test.")==
0?"host_sandbox":"host_custom"},getLoginHostUrl:function(){return e},setLoginHostType:function(a){a.toLowerCase()=="host_production"?ManageUserSession.setLoginHostUrl("login.salesforce.com"):a.toLowerCase()=="host_sandbox"?ManageUserSession.setLoginHostUrl("test.salesforce.com"):a.toLowerCase()=="host_custom"&&(e="")},setLoginHostUrl:function(a){a=a.toLowerCase();if(!c||e!=a&&confirm("Changing login host will logout the current logged in user. Are you sure you want to continue?")){e=a;SalesforceOAuthPlugin.setLoginDomain(null,
null,e);c&&ManageUserSession.kill()}},initialize:function(d){if(c)d();else{a(d,true);SalesforceOAuthPlugin.getLoginDomain(function(a){e=a.toLowerCase()});b||(b=new sforce.Client(a))}},invalidate:function(a,e){a&&c&&b.revokeSession(null,null,null,null,e);b=c=d=void 0},kill:function(){if(c){ManageUserSession.invalidate();SalesforceOAuthPlugin.logout()}}}}();
...
void 0!=window.LocalyticsManager&&function(){var a=function(a){return a<100?"< 100":a<200?"100 - 200":a<500?"200 - 500":"> 500"},b=function(a,b){if(!b||!b.length)b=[500,1E3,2E3];for(var e in b)if(a<b[e])return(e==0?"< ":b[e-1]/1E3+" - ")+b[e]/1E3+"s"};LocalyticsManager.tagScreen=function(a){localyticsSession.tagScreen(a)};LocalyticsManager.tagScreenOrientation=function(a){this.tagScreen(a?"Portrait":"Landscape")};LocalyticsManager.tagEvent=function(a,b){localyticsSession.tagEvent(a,b)};LocalyticsManager.tagListView=
function(c,d,e){this.tagEvent("Render List",{list:c,resultsetSize:a(d),loadTimeRange:b(e),loadTime:e})};LocalyticsManager.tagSearch=function(c,d,e){this.tagEvent("Search",{textLength:c<3?"< 3":c<5?"3 - 5":"> 5",resultsetSize:a(d),loadTimeRange:b(e),loadTime:e})};LocalyticsManager.tagDetailView=function(a,d){this.tagEvent("Render Detail",{view:a,loadTimeRange:b(d),loadTime:d})};LocalyticsManager.logAppStarted=function(){this.appStartTime=Date.now()};LocalyticsManager.logAuthComplete=function(){if(!this.appStartTime)this.appStartTime=
Date.now();this.appAuthTime=Date.now()};LocalyticsManager.logAppReady=function(){var a,d;this.appAuthTime&&(a=Date.now()-this.appStartTime);d=Date.now()-this.appAuthTime;this.tagEvent("App Ready",{authTime:a,dataLoadTime:d,authTimeRange:b(a,[2E3,5E3,1E4]),dataLoadTimeRange:b(d,[2E3,5E3,1E4]),totalLoadTimeRange:b(a+d,[5E3,1E4,15E3])})}}();function saveUserPic(){navigator.camera.getPicture(onPicSuccess,onPicFail,{quality:50})}
function showContactPicture(a){a=(a=StorageManager.getLocalValue(a+"__pic"))?"data:image/jpeg;base64,"+a:staticRsrcUrl+"/images/userPicwBorder.png";$j("#photo_div img").attr("src",a)}function onPicSuccess(a){ManageUserSession.getApiClient().addAttachment("ContactViewer-UserPhoto",listView.selectedContactId,a);StorageManager.setLocalValue(listView.selectedContactId+"__pic",a);showContactPicture(listView.selectedContactId)}function onPicFail(a){console.log("Pic Failed because: "+a)}
$j(function(){$j("#photo_div img").enableTap().click(saveUserPic);if(typeof sforce.Client!="undefined")sforce.Client.prototype.addAttachment=function(a,b,c,d,e,f){var h=getBaseUrl()+"/services/apexrest/cvapi?action=insertSObject&sobject=Attachment";this.ajax("POST",h,{Name:a,ParentId:b,Body:c},d,e,f)}});
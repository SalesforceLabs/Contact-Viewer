...
this.x+"px,"+this.y+"px) scale("+c+")"+q,this.zoomed=!1)},isReady:function(){return!this.moved&&!this.zoomed&&!this.animating}};y=null;"undefined"!==typeof exports?exports.iScroll=n:h.iScroll=n})(window,document);
...
(function(c){function j(a,e){this.element=$j(a);this.options=e||{};if(window.Touch)this.element.off("touchstart").on("touchstart",this.eventListener(this))}var b;j.prototype={eventListener:function(a){return function(e){return a.handleEvent.apply(a,[e.originalEvent])}},handleEvent:function(a){switch(a.type){case "touchstart":this.onTouchStart(a);break;case "touchmove":this.onTouchMove(a);break;case "touchend":this.onTouchEnd(a)}},onTouchStart:function(a){a.preventDefault();this.moved=!1;this.theTarget=
...
!1);this.targetParent[0].addEventListener("touchend",this,!1)},onTouchMove:function(){this.moved=!0;if("function"==typeof this.options.onTapCancel)this.options.onTapCancel(this.theTarget);this.options.pressedClass&&this.theTarget.removeClass(this.options.pressedClass)},onTouchEnd:function(){var a=this.theTarget;this.targetParent[0].removeEventListener("touchmove",this,!1);this.targetParent[0].removeEventListener("touchend",this,!1);!this.moved&&this.theTarget&&(this.options.pressedClass&&this.theTarget.removeClass(this.options.pressedClass),
setTimeout(function(){var e=document.createEvent("MouseEvents");e.initEvent("click",!0,!0);a.dispatchEvent(e)},0));this.targetParent=this.theTarget=void 0}};c.fn.changePage=function(a,e,d){var g=this,f="object"==typeof a?a:c(a),b=g.parent(),a=b.width();b.is(f.parent())&&(e?(b.css("-webkit-transform","translate3d("+-1*a+"px, 0, 0)"),g.css("-webkit-transform","translate3d("+a+"px, 0, 0)"),a=0):(f.css("-webkit-transform","translate3d("+a+"px, 0, 0)"),a*=-1),e=function(){g.css("visibility","hidden").css("-webkit-transform",
"translate3d(0, 0, 0)");b.css("-webkit-transform","translate3d(0, 0, 0)");f.css("-webkit-transform","translate3d(0, 0, 0)");typeof d=="function"&&d()},f.css("visibility","visible"),b.slide("translate3d("+a+"px, 0, 0)",e))};c.fn.scrollHeight=function(){return this[0].scrollHeight};c.fn.slide=function(a,e){var d=this,c="-"+vendor.toLowerCase()+"-transform";this.off("webkitTransitionEnd").on("webkitTransitionEnd",function(a){d.is(a.target)&&(d.removeClass("transitionSettings").css(vendor+"TransitionProperty",
"none"),d.off("webkitTransitionEnd"),"function"==typeof e&&e())});this.addClass("transitionSettings").css("visibility","visible");setTimeout(function(){d.css(vendor+"TransitionProperty",c).css(vendor+"Transform",a)},10)};c.fn.slideIn=function(a,e,d,c){var b,h;switch(a.toUpperCase()){case "X":b="translate3d("+e+"px, 0px, 0px)";h="translate3d("+d+"px, 0px, 0px)";break;case "Y":b="translate3d(0px, "+e+"px, 0px)",h="translate3d(0px, "+d+"px, 0px)"}this.css("visibility","hidden").css(vendor+"TransitionProperty",
"none").css(vendor+"Transform",b);this.slide(h,c)};c.fn.slideOut=function(a,e,d){var c=this,b;switch(a.toUpperCase()){case "X":b="translate3d("+e+"px, 0px, 0px)";break;case "Y":b="translate3d(0px, "+e+"px, 0px)"}this.slide(b,function(){c.css("visibility","hidden");"function"==typeof d&&d()})};c.fn.slideInLeft=function(a){var e=this.parent().width()-this.outerWidth();this.slideIn("X",this.parent().width(),e,a)};c.fn.slideOutRight=function(a){"block"==this.css("display")&&this.slideOut("X",this.parent().width(),
a)};c.fn.showActivityInd=function(a,e){var d;e&&(d=this.addOverlay());b?b.hide().off():(b=c("<div></div>").hide().append('<div id="spinner" style="position:relative; top:15px;"/>').append('<div id="text" style="margin: 45px 0 -5px 0;"/>'),b.appendTo(document.body));b[0].style.cssText="background-color:black; position: absolute; padding: 20px; color:white;-webkit-border-radius: 10px; text-align: center; z-index:1000";b.children("#text").text(a||"Loading...");var g=this.offset(),g=g?g:{left:0,top:0},
f=g.left+(this.width()-b.outerWidth(!1))/2,g=g.top+(this.height()-b.outerHeight(!1))/2;b.css("left",f).css("top",g);b[0].style.cssText+=";-webkit-transition:-webkit-transform 100ms ease-out;";b.show().children("#spinner").spin("large","white");return{hide:function(){b.css("-webkit-transition-property","-webkit-transform, opacity");b.on("webkitTransitionEnd",function(){b.hide()});b.css({webkitTransform:"scale3d(0.5, 0.5, 1)",opacity:"0"});b.children("#spinner").spin(false);d&&d.hide()}}};c.fn.addOverlay=
function(){var a=this,e=c.topZIndex(a),d=c("<div></div>").hide();d[0].style.cssText="background-color: black; border: none; opacity: 0.5; position: absolute; z-index:"+(e+10)+";";d.css({width:a.width(),height:a.height()});d.appendTo(a).show().offset(a.offset());d.orientationChange(function(){d.offset(a.offset());d.css({width:a.width(),height:a.height()})});return{elem:d,hide:function(){d.off("orientationchange").hide().remove()}}};c.fn.positionCenterOf=function(a){var e=$j(a).height()/2-this.outerHeight()/
2,a=$j(a).width()/2-this.outerWidth()/2;this.offset({top:e,left:a})};c.fn.orientationChange=function(a){if(/AppleWebKit/i.test(navigator.appVersion)&&"orientation"in window&&"onorientationchange"in window)this.on("orientationchange",a);else $j(window).resize(a);return this};c.fn.unbindOrientationChange=function(a){/AppleWebKit/i.test(navigator.appVersion)&&window.onorientationchange?this.off("orientationchange",a):$j(window).off("resize",a);return this};c.fn.touch=function(a){if(window.Touch)this.on("touchstart",
a);else this.on("click",a);return this};c.fn.unbindTouch=function(a){window.Touch?this.off("touchstart",a):this.off("click",a);return this};c.fn.enableTap=function(a){new j(this,a);return this};c.fn.setText=function(a,e,d){this.text("");var d=d||this,c=d.width();" "==a?this.html("&nbsp;"):this.text(a);for(var b=d.width()+1;e&&3<a.length&&d.width()>c&&d.width()<b;)a=a.substring(0,Math.max(0,a.length-4))+"...",b=d.width(),this.text(a);return this};c.fn.windowTouch=function(a,e,d){var c=this,b=function(b){var f=
b.target,i=!0;c.data("windowTouch")&&(3==f.nodeType&&(f=f.parentNode),$j(f).is(c)||0<c.has(f).length?"function"==typeof a&&(i=a(b)):"function"==typeof e&&(i=e(b)),(d||i)&&c.unbindWindowTouch())};this.data("windowTouch",{handler:b});$j(window).touch(b);return this};c.fn.unbindWindowTouch=function(){if(this.data("windowTouch")){var a=this.data("windowTouch").handler;this.removeData("windowTouch");a&&$j(window).unbindTouch(a)}return this};c.fn.textfill=function(a){var a=a.maxFontPixels,b=c("span:visible:first",
this),d=c(this).height(),g=c(this).width(),f,h;do b.css("font-size",a),f=b.height(),h=b.width(),a-=1;while((f>d||h>g)&&3<a);return this}})(jQuery);
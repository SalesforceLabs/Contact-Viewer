...
"function"&&d(false);else{var e=$j(document).showActivityInd("Authenticating...",false),j=StorageManager.getLocalValue(g),h=StorageManager.getLocalValue(f);k.refreshAccessToken(c,j,h,function(c){if(c.success){a(c);typeof d=="function"&&d(true);typeof b=="function"&&b()}else{c.errorCode=="INVALID_TOKEN"&&StorageManager.clearAll();typeof d=="function"&&d(c.success,c.error)}},function(a,b){typeof d=="function"&&d(false,b=="error"?"Server Unavailable. Check network connection or try again later.":
"Request timed out. Please try again.")},e.hide)}})}function d(){var a;switch(ManageUserSession.getLoginHostType()){case "host_production":a="login.salesforce.com";break;case "host_sandbox":a="test.salesforce.com";break;case "host_custom":a=StorageManager.getLocalValue(h)}if(!a||a.length==0)a="login.salesforce.com";return a}function e(b,c){var d=function(d,e){var d=d==-1?void 0:d,j=$j(document).showActivityInd(d?"Setting Passcode...":"Authenticating...",false);k.obtainAccessToken(ManageUserSession.getLoginHostUrl(),

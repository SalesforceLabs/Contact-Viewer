...
void 0!=window.LocalyticsManager&&function(){var a=function(a){return a<100?"< 100":a<200?"100 - 200":a<500?"200 - 500":"> 500"},b=function(a,b){if(!b||!b.length)b=[500,1E3,2E3];for(var e in b)if(a<b[e])return(e==0?"< ":b[e-1]/1E3+" - ")+b[e]/1E3+"s";return">"+b[b.length-1]};LocalyticsManager.tagScreen=function(a){localyticsSession.tagScreen(a)};LocalyticsManager.tagScreenOrientation=function(a){this.tagScreen(a?"Portrait":"Landscape")};LocalyticsManager.tagEvent=function(a,b){localyticsSession.tagEvent(a,
b)};LocalyticsManager.tagListView=function(c,d,e){this.tagEvent("Render List",{list:c,resultsetSize:a(d),loadTimeRange:b(e),loadTime:e})};LocalyticsManager.tagSearch=function(c,d,e){this.tagEvent("Search",{textLength:c<3?"< 3":c<5?"3 - 5":"> 5",resultsetSize:a(d),loadTimeRange:b(e),loadTime:e})};LocalyticsManager.tagDetailView=function(a,d){this.tagEvent("Render Detail",{view:a,loadTimeRange:b(d),loadTime:d})};LocalyticsManager.logAppStarted=function(){this.appStartTime=Date.now()};LocalyticsManager.logAuthComplete=
function(){if(!this.appStartTime)this.appStartTime=Date.now();this.appAuthTime=Date.now()};LocalyticsManager.logAppReady=function(){var a,d;this.appAuthTime&&(a=Date.now()-this.appStartTime);d=Date.now()-this.appAuthTime;this.tagEvent("App Ready",{authTime:a,dataLoadTime:d,authTimeRange:b(a,[2E3,5E3,1E4]),dataLoadTimeRange:b(d,[2E3,5E3,1E4]),totalLoadTimeRange:b(a+d,[5E3,1E4,15E3])})}}();
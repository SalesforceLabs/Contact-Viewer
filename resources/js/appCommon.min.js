...
"About")});b.find("#main #help #help_faq").enableTap().click(function(){m("#faq","FAQ",function(){})});b.find("#main #help #help_feedback").enableTap().click(function(){location.href="mailto:"+feedbackEmail});b.find("#main #help #help_eula").enableTap().click(function(){m("#eula","Contact Viewer EULA",k)});b.find("#loginbtn").off().enableTap().click(function(){prepareSession()});b.find("#logoutbtn").off().enableTap().click(function(){confirm("Logout user "+ManageUserSession.getUsername()+"?")&&logout(false)})}j();
...
$j(this).off("click");if(!ManageUserSession.isActive())window.location=getBaseUrl()});ManageUserSession.isActive()||b.find("#header #done").hide();d=window.innerHeight;e=(window.innerHeight-b.height())/2;b.hide().css("zIndex",$j.topZIndex(f.elem)+10).css({left:(window.innerWidth-b.width())/2});useAnimations?b.css({top:0}).show().slideIn("Y",d,e):b.css({top:e}).show();a("#main");b.orientationChange(p);LocalyticsManager.tagScreen("Settings")},hide:function(a){var c=window.innerHeight,d=function(){b.hide();

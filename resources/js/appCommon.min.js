...
e.hide)}})}function d(){var a;switch(ManageUserSession.getLoginHostType()){case "host_production":a="login.salesforce.com";break;case "host_sandbox":a="test.salesforce.com";break;case "host_custom":a=StorageManager.getLocalValue(h)}if(!a||a.length==0)a="login.salesforce.com";return a}function e(b,c){var d=function(d,e){var d=d==-1?void 0:d,j=$j(document).showActivityInd(d?"Setting Passcode...":"Authenticating...",false);k.obtainAccessToken(ManageUserSession.getLoginHostUrl(),b,d,function(b){j.hide();
if(b.success){a(b);var n=b.clientId,b=d?b.refreshToken:null;n&&n.length>0&&StorageManager.setLocalValue(g,n);b&&b.length>0&&StorageManager.setLocalValue(f,b);typeof c=="function"&&c()}else alert(b.error);typeof e=="function"&&e()},function(){if(confirm("Failed to obtain access. Try again!"))window.location=k.getAuthorizeUrl(ManageUserSession.getLoginHostUrl())})};p?PasscodeManager.setupPasscode(d):d()}var f="SFDC-OAUTH-TOKEN",g="SFDC-CLIENT-ID",h="SFDC-LOGIN-HOST-URL",l="SFDC-SESSION-TOKEN",k,m,o,

var SalesforceOAuthPlugin = {
	...
	*/
     ...
     *
     * This method will either return the login domain if configured by the user, or a default value set within the app.
     */
    getLoginDomain: function(success) {
        PhoneGap.exec(success, null, "com.salesforce.oauth", "getLoginDomain", []);
    },
     ...
     *   success         - The success callback function to use.
     *   fail            - The failure/error callback function to use.
     *   domain          - The domain to be used for future user authentication.
     */
    setLoginDomain: function(success, fail, domain) {
        PhoneGap.exec(success, fail, "com.salesforce.oauth", "setLoginDomain", [domain]);
    }
};

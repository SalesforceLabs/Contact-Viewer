...
PhoneGap.onNativeReady]);document.addEventListener("DOMContentLoaded",function(){PhoneGap.onDOMContentLoaded.fire()},!1);PhoneGap.m_document_addEventListener=document.addEventListener;PhoneGap.m_window_addEventListener=window.addEventListener;PhoneGap.addWindowEventHandler=function(a,b){PhoneGap.windowEventHandler[a]=b};PhoneGap.addDocumentEventHandler=function(a,b){PhoneGap.documentEventHandler[a]=b};document.addEventListener=function(a,b,c){var d=a.toLowerCase();if(d==="deviceready")PhoneGap.onDeviceReady.subscribeOnce(b);
else if(d==="resume"){PhoneGap.onResume.subscribe(b);PhoneGap.onDeviceReady.fired&&PhoneGap.onResume.fire()}else if(d==="pause")PhoneGap.onPause.subscribe(b);else{if(d==="backbutton")PhoneGap.exec(null,null,"App","overrideBackbutton",[true]);else if(typeof PhoneGap.documentEventHandler[d]!=="undefined"&&PhoneGap.documentEventHandler[d](d,b,true))return;PhoneGap.m_document_addEventListener.call(document,a,b,c)}};window.addEventListener=function(a,b,c){var d=a.toLowerCase();typeof PhoneGap.windowEventHandler[d]!==
"undefined"&&PhoneGap.windowEventHandler[d](d,b,true)||PhoneGap.m_window_addEventListener.call(window,a,b,c)};PhoneGap.m_document_removeEventListener=document.removeEventListener;PhoneGap.m_window_removeEventListener=window.removeEventListener;document.removeEventListener=function(a,b,c){var d=a.toLowerCase();d==="backbutton"&&PhoneGap.exec(null,null,"App","overrideBackbutton",[false]);typeof PhoneGap.documentEventHandler[d]!=="undefined"&&PhoneGap.documentEventHandler[d](d,b,false)||PhoneGap.m_document_removeEventListener.call(document,
a,b,c)};window.removeEventListener=function(a,b,c){var d=a.toLowerCase();typeof PhoneGap.windowEventHandler[d]!=="undefined"&&PhoneGap.windowEventHandler[d](d,b,false)||PhoneGap.m_window_removeEventListener.call(window,a,b,c)};PhoneGap.fireDocumentEvent=function(a,b){var c=document.createEvent("Events");c.initEvent(a);if(b)for(var d in b)c[d]=b[d];document.dispatchEvent(c)};PhoneGap.fireWindowEvent=function(a,b){var c=document.createEvent("Events");c.initEvent(a);if(b)for(var d in b)c[d]=b[d];window.dispatchEvent(c)};
PhoneGap.stringify=function(a){if(typeof JSON==="undefined"){var b="[",c,d,e;for(c=0;c<a.length;c++)if(a[c]!==null){c>0&&(b=b+",");d=typeof a[c];if(d==="number"||d==="boolean")b=b+a[c];else if(a[c]instanceof Array)b=b+"["+a[c]+"]";else if(a[c]instanceof Object){d=true;b=b+"{";for(e in a[c])if(a[c][e]!==null){d||(b=b+",");b=b+'"'+e+'":';d=typeof a[c][e];b=d==="number"||d==="boolean"?b+a[c][e]:typeof a[c][e]==="function"?b+'""':a[c][e]instanceof Object?b+PhoneGap.stringify(a[c][e]):b+'"'+a[c][e]+'"';
d=false}b=b+"}"}else{d=a[c].replace(/\\/g,"\\\\");d=d.replace(/"/g,'\\"');b=b+'"'+d+'"'}}return b+"]"}return JSON.stringify(a)};PhoneGap.clone=function(a){var b,c;if(!a)return a;if(a instanceof Array){c=[];for(b=0;b<a.length;++b)c.push(PhoneGap.clone(a[b]));return c}if(typeof a==="function"||!(a instanceof Object)||a instanceof Date)return a;c={};for(b in a)if(!(b in c)||c[b]!==a[b])c[b]=PhoneGap.clone(a[b]);return c};PhoneGap.callbackId=0;PhoneGap.callbacks={};PhoneGap.callbackStatus={NO_RESULT:0,
OK:1,CLASS_NOT_FOUND_EXCEPTION:2,ILLEGAL_ACCESS_EXCEPTION:3,INSTANTIATION_EXCEPTION:4,MALFORMED_URL_EXCEPTION:5,IO_EXCEPTION:6,INVALID_ACTION:7,JSON_EXCEPTION:8,ERROR:9};PhoneGap.exec=function(a,b,c,d,e){try{var f=c+PhoneGap.callbackId++;if(a||b)PhoneGap.callbacks[f]={success:a,fail:b};var g=prompt(PhoneGap.stringify(e),"gap:"+PhoneGap.stringify([c,d,f,true]));if(g.length>0){eval("var v="+g+";");if(v.status===PhoneGap.callbackStatus.OK){if(a){try{a(v.message)}catch(h){console.log("Error in success callback: "+
f+" = "+h)}v.keepCallback||delete PhoneGap.callbacks[f]}return v.message}if(v.status===PhoneGap.callbackStatus.NO_RESULT)v.keepCallback||delete PhoneGap.callbacks[f];else{console.log("Error: Status="+v.status+" Message="+v.message);if(b){try{b(v.message)}catch(i){console.log("Error in error callback: "+f+" = "+i)}v.keepCallback||delete PhoneGap.callbacks[f]}return null}}}catch(j){console.log("Error: "+j)}};PhoneGap.callbackSuccess=function(a,b){if(PhoneGap.callbacks[a]){if(b.status===PhoneGap.callbackStatus.OK)try{PhoneGap.callbacks[a].success&&
PhoneGap.callbacks[a].success(b.message)}catch(c){console.log("Error in success callback: "+a+" = "+c)}b.keepCallback||delete PhoneGap.callbacks[a]}};PhoneGap.callbackError=function(a,b){if(PhoneGap.callbacks[a]){try{PhoneGap.callbacks[a].fail&&PhoneGap.callbacks[a].fail(b.message)}catch(c){console.log("Error in error callback: "+a+" = "+c)}b.keepCallback||delete PhoneGap.callbacks[a]}};PhoneGap.run_command=function(){if(PhoneGap.available&&PhoneGap.queue.ready){PhoneGap.queue.ready=false;var a=PhoneGap.queue.commands.shift();
if(PhoneGap.queue.commands.length===0){clearInterval(PhoneGap.queue.timer);PhoneGap.queue.timer=null}var b=[],c=null,d;for(d=1;d<a.length;d++){var e=a[d];if(e===void 0||e===null)e="";typeof e==="object"?c=e:b.push(encodeURIComponent(e))}a="gap://"+a[0]+"/"+b.join("/");if(c!==null){var f,b=[];for(f in c)c.hasOwnProperty(f)&&typeof f==="string"&&b.push(encodeURIComponent(f)+"="+encodeURIComponent(c[f]));b.length>0&&(a=a+("?"+b.join("&")))}document.location=a}};PhoneGap.JSCallbackPort=null;PhoneGap.JSCallbackToken=
null;PhoneGap.JSCallback=function(){if(!PhoneGap.shuttingDown)if(PhoneGap.UsePolling)PhoneGap.JSCallbackPolling();else{var a=new XMLHttpRequest;a.onreadystatechange=function(){if(a.readyState===4&&!PhoneGap.shuttingDown)if(a.status===200){var b=decodeURIComponent(a.responseText);setTimeout(function(){try{eval(b)}catch(a){console.log("JSCallback: Message from Server: "+b);console.log("JSCallback Error: "+a)}},1);setTimeout(PhoneGap.JSCallback,1)}else if(a.status===404)setTimeout(PhoneGap.JSCallback,
10);else if(a.status===403)console.log("JSCallback Error: Invalid token.  Stopping callbacks.");else if(a.status===503)console.log("JSCallback Server Closed: Stopping callbacks.");else if(a.status===400)console.log("JSCallback Error: Bad request.  Stopping callbacks.");else{console.log("JSCallback Error: Request failed.");PhoneGap.UsePolling=true;PhoneGap.JSCallbackPolling()}};if(PhoneGap.JSCallbackPort===null)PhoneGap.JSCallbackPort=prompt("getPort","gap_callbackServer:");if(PhoneGap.JSCallbackToken===
null)PhoneGap.JSCallbackToken=prompt("getToken","gap_callbackServer:");a.open("GET","http://127.0.0.1:"+PhoneGap.JSCallbackPort+"/"+PhoneGap.JSCallbackToken,true);a.send()}};PhoneGap.JSCallbackPollingPeriod=50;PhoneGap.UsePolling=!1;PhoneGap.JSCallbackPolling=function(){if(!PhoneGap.shuttingDown)if(PhoneGap.UsePolling){var a=prompt("","gap_poll:");if(a){setTimeout(function(){try{eval(""+a)}catch(b){console.log("JSCallbackPolling: Message from Server: "+a);console.log("JSCallbackPolling Error: "+b)}},
1);setTimeout(PhoneGap.JSCallbackPolling,1)}else setTimeout(PhoneGap.JSCallbackPolling,PhoneGap.JSCallbackPollingPeriod)}else PhoneGap.JSCallback()};PhoneGap.createUUID=function(){return PhoneGap.UUIDcreatePart(4)+"-"+PhoneGap.UUIDcreatePart(2)+"-"+PhoneGap.UUIDcreatePart(2)+"-"+PhoneGap.UUIDcreatePart(2)+"-"+PhoneGap.UUIDcreatePart(6)};PhoneGap.UUIDcreatePart=function(a){var b="",c,d;for(c=0;c<a;c++){d=parseInt(Math.random()*256,0).toString(16);d.length===1&&(d="0"+d);b=b+d}return b};PhoneGap.close=
function(a,b,c){return typeof c==="undefined"?function(){return b.apply(a,arguments)}:function(){return b.apply(a,c)}};PhoneGap.includeJavascript=function(a,b){var c=document.getElementsByTagName("head")[0],d=document.createElement("script");d.type="text/javascript";if(typeof b==="function")d.onload=b;d.src=a;c.appendChild(d)}}
...
if(!PhoneGap.hasResource("filetransfer")){PhoneGap.addResource("filetransfer");var FileTransfer=function(){},FileUploadResult=function(){this.bytesSent=0;this.response=this.responseCode=null},FileTransferError=function(){this.code=null};FileTransferError.FILE_NOT_FOUND_ERR=1;FileTransferError.INVALID_URL_ERR=2;FileTransferError.CONNECTION_ERR=3;FileTransfer.prototype.upload=function(a,b,c,d,e,f){var g=null,h=null,i=null,j=null,k=true;if(e){g=e.fileKey;h=e.fileName;i=e.mimeType;if(e.chunkedMode!=null||
typeof e.chunkedMode!="undefined")k=e.chunkedMode;j=e.params?e.params:{}}PhoneGap.exec(c,d,"FileTransfer","upload",[a,b,g,h,i,j,f,k])};var FileUploadOptions=function(a,b,c,d){this.fileKey=a||null;this.fileName=b||null;this.mimeType=c||null;this.params=d||null}}
...
"Geolocation Error: Still waiting for previous getCurrentPosition() request."))}catch(d){}}else{var e=1E4,f=false,g=1E4;if(typeof c!=="undefined"){if(typeof c.maximumAge!=="undefined")e=c.maximumAge;if(typeof c.enableHighAccuracy!=="undefined")f=c.enableHighAccuracy;if(typeof c.timeout!=="undefined")g=c.timeout}navigator._geo.listeners.global={success:a,fail:b};PhoneGap.exec(null,null,"Geolocation","getCurrentLocation",[f,g,e])}};Geolocation.prototype.watchPosition=function(a,b,c){var d=1E4,e=false,
f=1E4;if(typeof c!=="undefined"){if(typeof c.frequency!=="undefined")d=c.frequency;if(typeof c.maximumAge!=="undefined")d=c.maximumAge;if(typeof c.enableHighAccuracy!=="undefined")e=c.enableHighAccuracy;if(typeof c.timeout!=="undefined")f=c.timeout}c=PhoneGap.createUUID();navigator._geo.listeners[c]={success:a,fail:b};PhoneGap.exec(null,null,"Geolocation","start",[c,e,f,d]);return c};Geolocation.prototype.success=function(a,b,c,d,e,f,g,h){d=new Coordinates(b,c,d,e,f,g);h=new Position(d,h);try{if(b===
"undefined"||c==="undefined")navigator._geo.listeners[a].fail(new PositionError(PositionError.POSITION_UNAVAILABLE,"Lat/Lng are undefined."));else{navigator._geo.lastPosition=h;navigator._geo.listeners[a].success(h)}}catch(i){console.log("Geolocation Error: Error calling success callback function.")}a==="global"&&delete navigator._geo.listeners.global};Geolocation.prototype.fail=function(a,b,c){try{navigator._geo.listeners[a].fail(new PositionError(b,c))}catch(d){console.log("Geolocation Error: Error calling error callback function.")}};
...
if(!PhoneGap.hasResource("media")){PhoneGap.addResource("media");var Media=function(a,b,c,d,e){if(b&&typeof b!=="function")console.log("Media Error: successCallback is not a function");else if(c&&typeof c!=="function")console.log("Media Error: errorCallback is not a function");else if(d&&typeof d!=="function")console.log("Media Error: statusCallback is not a function");else if(e&&typeof e!=="function")console.log("Media Error: positionCallback is not a function");else{this.id=PhoneGap.createUUID();
...
if(!PhoneGap.hasResource("position")){PhoneGap.addResource("position");var Position=function(a,b){this.coords=a;this.timestamp=b!=="undefined"?b:(new Date).getTime()},Coordinates=function(a,b,c,d,e,f,g){this.latitude=a;this.longitude=b;this.accuracy=d;this.altitude=c;this.heading=e;this.speed=f;this.altitudeAccuracy=g!=="undefined"?g:null},PositionOptions=function(){this.enableHighAccuracy=true;this.timeout=1E4},PositionError=function(){this.code=null;this.message=""};PositionError.UNKNOWN_ERROR=
0;PositionError.PERMISSION_DENIED=1;PositionError.POSITION_UNAVAILABLE=2;PositionError.TIMEOUT=3}
if(!PhoneGap.hasResource("storage")){PhoneGap.addResource("storage");var DroidDB_Rows=function(){this.resultSet=[];this.length=0};DroidDB_Rows.prototype.item=function(a){return this.resultSet[a]};var DroidDB_Result=function(){this.rows=new DroidDB_Rows},DroidDB=function(){this.queryQueue={}};DroidDB.prototype.completeQuery=function(a,b){var c=this.queryQueue[a];if(c)try{delete this.queryQueue[a];var d=c.tx;if(d&&d.queryList[a]){var e=new DroidDB_Result;e.rows.resultSet=b;e.rows.length=b.length;try{typeof c.successCallback===
"function"&&c.successCallback(c.tx,e)}catch(f){console.log("executeSql error calling user success callback: "+f)}d.queryComplete(a)}}catch(g){console.log("executeSql error: "+g)}};DroidDB.prototype.fail=function(a,b){var c=this.queryQueue[b];if(c)try{delete this.queryQueue[b];var d=c.tx;if(d&&d.queryList[b]){d.queryList={};try{typeof c.errorCallback==="function"&&c.errorCallback(c.tx,a)}catch(e){console.log("executeSql error calling user error callback: "+e)}d.queryFailed(b,a)}}catch(f){console.log("executeSql error: "+
f)}};var DroidDB_Query=function(a){this.id=PhoneGap.createUUID();droiddb.queryQueue[this.id]=this;this.resultSet=[];this.tx=a;this.tx.queryList[this.id]=this;this.errorCallback=this.successCallback=null},DroidDB_Tx=function(){this.id=PhoneGap.createUUID();this.errorCallback=this.successCallback=null;this.queryList={}};DroidDB_Tx.prototype.queryComplete=function(a){delete this.queryList[a];if(this.successCallback){var a=0,b;for(b in this.queryList)this.queryList.hasOwnProperty(b)&&a++;if(a===0)try{this.successCallback()}catch(c){console.log("Transaction error calling user success callback: "+
c)}}};DroidDB_Tx.prototype.queryFailed=function(a,b){this.queryList={};if(this.errorCallback)try{this.errorCallback(b)}catch(c){console.log("Transaction error calling user error callback: "+c)}};DroidDB_Tx.prototype.executeSql=function(a,b,c,d){typeof b==="undefined"&&(b=[]);var e=new DroidDB_Query(this);droiddb.queryQueue[e.id]=e;e.successCallback=c;e.errorCallback=d;PhoneGap.exec(null,null,"Storage","executeSql",[a,b,e.id])};var DatabaseShell=function(){};DatabaseShell.prototype.transaction=function(a,
...
a.executeSql("DELETE FROM storage",[])})};this.key=function(b){var c=0,f;for(f in a){if(c==b)return f;c++}return null}}catch(c){alert("Database error "+c+".")}};PhoneGap.addConstructor(function(){var a=function(){navigator.openDatabase=window.openDatabase=DroidDB_openDatabase;window.droiddb=new DroidDB};if(typeof window.openDatabase==="undefined")a();else{window.openDatabase_orig=window.openDatabase;window.openDatabase=function(b,c,d,e){var f=null;try{f=window.openDatabase_orig(b,c,d,e)}catch(g){f=
null}if(f==null){a();return DroidDB_openDatabase(b,c,d,e)}return f}}if(typeof window.localStorage==="undefined"){navigator.localStorage=window.localStorage=new CupcakeLocalStorage;PhoneGap.waitForInitialization("cupcakeStorage")}})};

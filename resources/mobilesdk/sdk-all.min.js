...
return gapBridge},PhoneGap.exec=function(){if(PhoneGap.available){var a,b,c,d,e,f=null;"string"!==typeof arguments[0]?(a=arguments[0],b=arguments[1],c=arguments[2],d=arguments[3],e=arguments[4],f="INVALID"):(splitCommand=arguments[0].split("."),d=splitCommand.pop(),c=splitCommand.join("."),e=Array.prototype.splice.call(arguments,1));d={className:c,methodName:d,arguments:[]};if(a||b)f=c+PhoneGap.callbackId++,PhoneGap.callbacks[f]={success:a,fail:b};null!=f&&d.arguments.push(f);for(a=0;a<e.length;++a)b=
e[a],void 0==b||null==b||("object"==typeof b?d.options=b:d.arguments.push(b));PhoneGap.commandQueue.push(JSON.stringify(d));1==PhoneGap.commandQueue.length&&!PhoneGap.commandQueueFlushing&&(PhoneGap.gapBridge||(PhoneGap.gapBridge=PhoneGap.createGapBridge()),PhoneGap.gapBridge.src="gap://ready")}else alert("ERROR: Attempting to call PhoneGap.exec() before 'deviceready'. Ignoring.")},PhoneGap.getAndClearQueuedCommands=function(){json=JSON.stringify(PhoneGap.commandQueue);PhoneGap.commandQueue=[];return json},
...
function(a,b){PhoneGap.documentEventHandler[a]=b},document.addEventListener=function(a,b,c){var d=a.toLowerCase();"undefined"!==typeof PhoneGap.documentEventHandler[d]&&PhoneGap.documentEventHandler[d](d,b,!0)||PhoneGap.m_document_addEventListener.call(document,a,b,c)},window.addEventListener=function(a,b,c){var d=a.toLowerCase();"undefined"!==typeof PhoneGap.windowEventHandler[d]&&PhoneGap.windowEventHandler[d](d,b,!0)||PhoneGap.m_window_addEventListener.call(window,a,b,c)},PhoneGap.m_document_removeEventListener=
document.removeEventListener,PhoneGap.m_window_removeEventListener=window.removeEventListener,document.removeEventListener=function(a,b,c){var d=a.toLowerCase();"undefined"!==typeof PhoneGap.documentEventHandler[d]&&PhoneGap.documentEventHandler[d](d,b,!1)||PhoneGap.m_document_removeEventListener.call(document,a,b,c)},window.removeEventListener=function(a,b,c){var d=a.toLowerCase();"undefined"!==typeof PhoneGap.windowEventHandler[d]&&PhoneGap.windowEventHandler[d](d,b,!1)||PhoneGap.m_window_removeEventListener.call(window,
a,b,c)},PhoneGap.fireDocumentEvent=function(a,b){var c=document.createEvent("Events");c.initEvent(a);if(b)for(var d in b)c[d]=b[d];document.dispatchEvent(c)},PhoneGap.fireWindowEvent=function(a,b){var c=document.createEvent("Events");c.initEvent(a);if(b)for(var d in b)c[d]=b[d];window.dispatchEvent(c)},PhoneGap.fireEvent=function(a,b,c){var d=document.createEvent("Events");d.initEvent(a);if(c)for(var e in c)d[e]=c[e];b=b||document;void 0===b.dispatchEvent&&(b=document);b.dispatchEvent(d)},PhoneGap.createUUID=
function(){return PhoneGap.UUIDcreatePart(4)+"-"+PhoneGap.UUIDcreatePart(2)+"-"+PhoneGap.UUIDcreatePart(2)+"-"+PhoneGap.UUIDcreatePart(2)+"-"+PhoneGap.UUIDcreatePart(6)},PhoneGap.UUIDcreatePart=function(a){for(var b="",c=0;c<a;c++){var d=parseInt(256*Math.random()).toString(16);1==d.length&&(d="0"+d);b+=d}return b});
...
PhoneGap.hasResource("accelerometer")||(PhoneGap.addResource("accelerometer"),Accelerometer=function(){this.lastAcceleration=new Acceleration(0,0,0)},Accelerometer.prototype.getCurrentAcceleration=function(a){typeof a=="function"&&a(this.lastAcceleration)},Accelerometer.prototype._onAccelUpdate=function(a,b,c){this.lastAcceleration=new Acceleration(a,b,c)},Accelerometer.prototype.watchAcceleration=function(a,b,c){var d=c!=void 0&&c.frequency!=void 0?c.frequency:1E4;PhoneGap.exec(null,null,"com.phonegap.accelerometer",
"start",[c]);return setInterval(function(){navigator.accelerometer.getCurrentAcceleration(a,b,c)},d)},Accelerometer.prototype.clearWatch=function(a){PhoneGap.exec(null,null,"com.phonegap.accelerometer","stop",[]);clearInterval(a)},Accelerometer.install=function(){if(typeof navigator.accelerometer=="undefined")navigator.accelerometer=new Accelerometer},Accelerometer.installDeviceMotionHandler=function(){if(window.DeviceMotionEvent==void 0){var a=this;a.deviceMotionWatchId=null;a.deviceMotionListenerCount=
0;a.deviceMotionLastEventTimestamp=0;var b=window.addEventListener,c=window.removeEventListener,d=window.dispatchEvent!==void 0,e=function(b){var c=document.createEvent("Events");c.initEvent("devicemotion");c.acceleration=null;c.rotationRate=null;c.accelerationIncludingGravity=b;b=(new Date).getTime();c.interval=a.deviceMotionLastEventTimestamp==0?0:b-a.deviceMotionLastEventTimestamp;a.deviceMotionLastEventTimestamp=b;d?window.dispatchEvent(c):document.dispatchEvent(c)},f=function(){};window.addEventListener=
function(){if(arguments[0]==="devicemotion"){++a.deviceMotionListenerCount;if(a.deviceMotionListenerCount==1)a.deviceMotionWatchId=navigator.accelerometer.watchAcceleration(e,f,{frequency:500})}return d?b.apply(this,arguments):document.addEventListener.apply(this,arguments)};window.removeEventListener=function(){if(arguments[0]==="devicemotion"){--a.deviceMotionListenerCount;a.deviceMotionListenerCount==0&&navigator.accelerometer.clearWatch(a.deviceMotionWatchId)}return d?c.apply(this,arguments):
...
"captureAudio",[c])};Capture.prototype.captureImage=function(a,b,c){PhoneGap.exec(a,b,"com.phonegap.mediacapture","captureImage",[c])};Capture.prototype._castMediaFile=function(a){var b=[],c;for(c=0;c<a.message.length;c++){var d=new MediaFile;d.name=a.message[c].name;d.fullPath=a.message[c].fullPath;d.type=a.message[c].type;d.lastModifiedDate=a.message[c].lastModifiedDate;d.size=a.message[c].size;b.push(d)}a.message=b;return a};Capture.prototype.captureVideo=function(a,b,c){PhoneGap.exec(a,b,"com.phonegap.mediacapture",
"captureVideo",[c])};var ConfigurationData=function(){this.type;this.width=this.height=0},CaptureImageOptions=function(){this.limit=1;this.mode=null},CaptureVideoOptions=function(){this.limit=1;this.duration=0;this.mode=null},CaptureAudioOptions=function(){this.limit=1;this.duration=0;this.mode=null},MediaFile=function(a,b,c,d,e){this.name=a||null;this.fullPath=b||null;this.type=c||null;this.lastModifiedDate=d||null;this.size=e||0};MediaFile.prototype.getFormatData=function(a,b){typeof this.fullPath===
"undefined"||this.fullPath===null?b({code:CaptureError.CAPTURE_INVALID_ARGUMENT}):PhoneGap.exec(a,b,"com.phonegap.mediacapture","getFormatData",[this.fullPath,this.type])};var MediaFileData=function(a,b,c,d,e){this.codecs=a||null;this.bitrate=b||0;this.height=c||0;this.width=d||0;this.duration=e||0};PhoneGap.addConstructor(function(){if(typeof navigator.device==="undefined")navigator.device=window.device=new Device;if(typeof navigator.device.capture==="undefined")navigator.device.capture=window.device.capture=
new Capture})}
if(!PhoneGap.hasResource("contact")){PhoneGap.addResource("contact");var Contact=function(a,b,c,d,e,f,g,h,j,k,l,m,n,o){this.id=a||null;this.displayName=b||null;this.name=c||null;this.nickname=d||null;this.phoneNumbers=e||null;this.emails=f||null;this.addresses=g||null;this.ims=h||null;this.organizations=j||null;this.birthday=k||null;this.note=l||null;this.photos=m||null;this.categories=n||null;this.urls=o||null};Contact.prototype.convertDatesOut=function(){for(var a=["birthday"],b=0;b<a.length;b++){var c=
this[a[b]];if(c){if(!c instanceof Date)try{c=new Date(c)}catch(d){c=null}c instanceof Date&&(c=c.valueOf());this[a[b]]=c}}};Contact.prototype.convertDatesIn=function(){for(var a=["birthday"],b=0;b<a.length;b++){var c=this[a[b]];if(c)try{this[a[b]]=new Date(parseFloat(c))}catch(d){console.log("exception creating date")}}};Contact.prototype.remove=function(a,b){if(this.id==null){var c=new ContactError;c.code=ContactError.UNKNOWN_ERROR;b(c)}else PhoneGap.exec(a,b,"com.phonegap.contacts","remove",[{contact:this}])};
...
null;if(a.ims)for(i=0;i<a.ims.length;i++)a.ims[i].id=null;if(a.organizations)for(i=0;i<a.organizations.length;i++)a.organizations[i].id=null;if(a.photos)for(i=0;i<a.photos.length;i++)a.photos[i].id=null;if(a.urls)for(i=0;i<a.urls.length;i++)a.urls[i].id=null;return a};Contact.prototype.save=function(a,b){var c=PhoneGap.clone(this);c.convertDatesOut();PhoneGap.exec(a,b,"com.phonegap.contacts","save",[{contact:c}])};var ContactName=function(a,b,c,d,e,f){this.formatted=a!="undefined"?a:null;this.familyName=
b!="undefined"?b:null;this.givenName=c!="undefined"?c:null;this.middleName=d!="undefined"?d:null;this.honorificPrefix=e!="undefined"?e:null;this.honorificSuffix=f!="undefined"?f:null},ContactField=function(a,b,c,d){this.type=a!="undefined"?a:null;this.value=b!="undefined"?b:null;this.pref=c!="undefined"?c:null;this.id=d!="undefined"?d:null},ContactAddress=function(a,b,c,d,e,f,g,h,j){this.pref=a!="undefined"?a:null;this.type=b!="undefined"?b:null;this.formatted=c!="undefined"?c:null;this.streetAddress=
d!="undefined"?d:null;this.locality=e!="undefined"?e:null;this.region=f!="undefined"?f:null;this.postalCode=g!="undefined"?g:null;this.country=h!="undefined"?h:null;this.id=j!="undefined"?j:null},ContactOrganization=function(a,b,c,d,e){this.pref=a!="undefined"?a:null;this.type=b!="undefined"?b:null;this.name=c!="undefined"?c:null;this.department=d!="undefined"?d:null;this.title=e!="undefined"?e:null},Contacts=function(){this.inProgress=false;this.records=[]};Contacts.prototype.find=function(a,b,c,
d){if(b===null)throw new TypeError("You must specify a success callback for the find command.");a===null||a==="undefined"||a.length==="undefined"||a.length<=0?typeof c==="function"&&c({code:ContactError.INVALID_ARGUMENT_ERROR}):PhoneGap.exec(b,c,"com.phonegap.contacts","search",[{fields:a,findOptions:d}])};Contacts.prototype._findCallback=function(a){var b=[];try{for(var c=0;c<a.message.length;c++){var d=navigator.contacts.create(a.message[c]);d.convertDatesIn();b.push(d)}a.message=b}catch(e){console.log("Error parsing contacts: "+
e)}return a};Contacts.prototype._contactCallback=function(a){var b=null;if(a.message)try{b=navigator.contacts.create(a.message);b.convertDatesIn()}catch(c){console.log("Error parsing contact")}a.message=b;return a};Contacts.prototype._errCallback=function(a){var b=new ContactError;b.code=a.message;a.message=b;return a};Contacts.prototype.newContactUI=function(a){PhoneGap.exec(a,null,"com.phonegap.contacts","newContact",[])};Contacts.prototype.chooseContact=function(a,b){PhoneGap.exec(a,null,"com.phonegap.contacts",
...
PhoneGap.hasResource("file")||(PhoneGap.addResource("file"),FileProperties=function(a){this.filePath=a;this.size=0;this.lastModifiedDate=null},File=function(a,b,c,d,e){this.name=a||null;this.fullPath=b||null;this.type=c||null;this.lastModifiedDate=d||null;this.size=e||0},File._createEvent=function(a,b){var c={type:a};c.target=b;return c},FileError=function(){this.code=null},FileError.NOT_FOUND_ERR=1,FileError.SECURITY_ERR=2,FileError.ABORT_ERR=3,FileError.NOT_READABLE_ERR=4,FileError.ENCODING_ERR=
...
function(a,b){PhoneGap.exec(a,b,"com.phonegap.file","getFreeDiskSpace",[])},FileMgr.prototype.write=function(a,b,c,d,e){PhoneGap.exec(d,e,"com.phonegap.file","write",[a,b,c])},FileMgr.prototype.truncate=function(a,b,c,d){PhoneGap.exec(c,d,"com.phonegap.file","truncateFile",[a,b])},FileMgr.prototype.readAsText=function(a,b,c,d){PhoneGap.exec(c,d,"com.phonegap.file","readFile",[a,b])},FileMgr.prototype.readAsDataURL=function(a,b,c){PhoneGap.exec(b,c,"com.phonegap.file","readAsDataURL",[a])},PhoneGap.addConstructor(function(){if(typeof navigator.fileMgr===
...
"function"){a=File._createEvent("abort",this);this.onabort(a)}this.readyState=FileWriter.DONE;if(typeof this.onwriteend=="function"){a=File._createEvent("writeend",this);this.onwriteend(a)}},FileWriter.prototype.writeAsText=function(a,b,c){if(this.readyState===FileWriter.WRITING)throw FileError.INVALID_STATE_ERR;c!==true&&(c=false);this.fileName=a;this.readyState=FileWriter.WRITING;var d=this;if(typeof d.onwritestart==="function"){var e=File._createEvent("writestart",d);d.onwritestart(e)}navigator.fileMgr.writeAsText(a,
b,c,function(a){if(d.readyState!==FileWriter.DONE){d.result=a;if(typeof d.onwrite==="function"){a=File._createEvent("write",d);d.onwrite(a)}d.readyState=FileWriter.DONE;if(typeof d.onwriteend==="function"){a=File._createEvent("writeend",d);d.onwriteend(a)}}},function(a){if(d.readyState!==FileWriter.DONE){d.error=a;if(typeof d.onerror==="function"){a=File._createEvent("error",d);d.onerror(a)}d.readyState=FileWriter.DONE;if(typeof d.onwriteend==="function"){a=File._createEvent("writeend",d);d.onwriteend(a)}}})},
...
PhoneGap.hasResource("filetransfer")||(PhoneGap.addResource("filetransfer"),FileTransfer=function(){},FileUploadResult=function(){this.bytesSent=0;this.response=this.responseCode=null},FileTransferError=function(a){this.code=a||null},FileTransferError.FILE_NOT_FOUND_ERR=1,FileTransferError.INVALID_URL_ERR=2,FileTransferError.CONNECTION_ERR=3,FileTransfer.prototype.upload=function(a,b,c,d,e){if(!e.params)e.params={};e.filePath=a;e.server=b;if(!e.fileKey)e.fileKey="file";if(!e.fileName)e.fileName="image.jpg";
if(!e.mimeType)e.mimeType="image/jpeg";typeof c!="function"?console.log("FileTransfer Error: successCallback is not a function"):d&&typeof d!="function"?console.log("FileTransfer Error: errorCallback is not a function"):PhoneGap.exec(c,d,"com.phonegap.filetransfer","upload",[e])},FileTransfer.prototype._castTransferError=function(a){var b=new FileTransferError(a.message);a.message=b;return a},FileTransfer.prototype._castUploadResult=function(a){var b=new FileUploadResult;b.bytesSent=a.message.bytesSent;
b.responseCode=a.message.responseCode;b.response=decodeURIComponent(a.message.response);a.message=b;return a},FileTransfer.prototype.download=function(a,b,c,d){PhoneGap.exec(c,d,"com.phonegap.filetransfer","download",[a,b])},FileUploadOptions=function(a,b,c,d){this.fileKey=a||null;this.fileName=b||null;this.mimeType=c||null;this.params=d||null},PhoneGap.addConstructor(function(){if(typeof navigator.fileTransfer=="undefined")navigator.fileTransfer=new FileTransfer}));
PhoneGap.hasResource("geolocation")||(PhoneGap.addResource("geolocation"),Geolocation=function(){this.listener=this.lastPosition=null;this.timeoutTimerId=0},Geolocation.prototype.getCurrentPosition=function(a,b,c){var d=a;if(!d||typeof d!="function")d=function(){};var e=b;if(!e||typeof e!="function")e=function(){};var f=this,a=new PositionOptions;if(c){if(c.maximumAge){if(this.lastPosition&&(new Date).getTime()-this.lastPosition.timestamp<c.maximumAge){d(this.lastPosition);return}a.maximumAge=c.maximumAge}if(c.enableHighAccuracy)a.enableHighAccuracy=
c.enableHighAccuracy==true;if(c.timeout)a.timeout=c.timeout}c=d;if(!this.locationRunning){c=function(a){d(a);f.stop()};errorListener=function(a){e(a);f.stop()}}this.listener={success:c,fail:e};this.start(a);clearTimeout(this.timeoutTimerId);this.timeoutTimerId=setTimeout(function(){f.setError(new PositionError(PositionError.TIMEOUT,"Geolocation Error: Timeout."))},a.timeout)},Geolocation.prototype.watchPosition=function(a,b,c){var d=new PositionOptions;if(c){if(c.maximumAge)d.maximumAge=c.maximumAge;
if(c.enableHighAccuracy)d.enableHighAccuracy=c.enableHighAccuracy;if(c.timeout)d.timeout=c.timeout}var e=this,f=e.lastPosition?e.lastPosition.clone():null,c=function(){e.getCurrentPosition(function(b){(f==null||!b.equals(f))&&a(b);f=b.clone()},b,d)};c();return setInterval(c,d.timeout)},Geolocation.prototype.clearWatch=function(a){clearInterval(a)},Geolocation.prototype.setLocation=function(a){a=new Position(a.coords,a.timestamp);if(this.timeoutTimerId){clearTimeout(this.timeoutTimerId);this.timeoutTimerId=
0}this.lastError=null;this.lastPosition=a;this.listener&&typeof this.listener.success=="function"&&this.listener.success(a);this.listener=null},Geolocation.prototype.setError=function(a){a=new PositionError(a.code,a.message);this.locationRunning=false;if(this.timeoutTimerId){clearTimeout(this.timeoutTimerId);this.timeoutTimerId=0}this.lastError=a;this.listener&&typeof this.listener.fail=="function"&&this.listener.fail(a);this.listener=null},Geolocation.prototype.start=function(a){PhoneGap.exec(null,
null,"com.phonegap.geolocation","startLocation",[a]);this.locationRunning=true},Geolocation.prototype.stop=function(){PhoneGap.exec(null,null,"com.phonegap.geolocation","stopLocation",[]);this.locationRunning=false},PhoneGap.addConstructor(function(){if(typeof navigator._geo=="undefined"){navigator._geo=new Geolocation;(function(a,b,c){var d=function(a,b,c){a[c]=function(){return b[c].apply(b,arguments)}},e;for(e in c)d(a,b,c[e])})(navigator.geolocation,navigator._geo,["setLocation","getCurrentPosition",
"watchPosition","clearWatch","setError","start","stop"])}}));
...
PhoneGap.exec(a,b,"com.phonegap.geolocation","getCurrentHeading",[])},Compass.prototype.watchHeading=function(a,b,c){c=c!==void 0?c.frequency:100;if(typeof a!=="function")console.log("Compass Error: successCallback is not a function");else if(b&&typeof b!=="function")console.log("Compass Error: errorCallback is not a function");else{var d=PhoneGap.createUUID();navigator.compass.timers[d]=setInterval(function(){PhoneGap.exec(a,b,"com.phonegap.geolocation","getCurrentHeading",[{repeats:1}])},c);return d}},
...
Media.MEDIA_POSITION)a._position=c},Media=function(a,b,c,d,e){if(b&&typeof b!="function")console.log("Media Error: successCallback is not a function");else if(c&&typeof c!="function")console.log("Media Error: errorCallback is not a function");else if(d&&typeof d!="function")console.log("Media Error: statusCallback is not a function");else if(e&&typeof e!="function")console.log("Media Error: positionCallback is not a function");else{this.id=PhoneGap.createUUID();PhoneGap.mediaObjects[this.id]=this;
this.src=a;this.successCallback=b;this.errorCallback=c;this.statusCallback=d;this.positionCallback=e;this._position=this._duration=-1}},Media.MEDIA_STATE=1,Media.MEDIA_DURATION=2,Media.MEDIA_POSITION=3,Media.MEDIA_ERROR=9,Media.MEDIA_NONE=0,Media.MEDIA_STARTING=1,Media.MEDIA_RUNNING=2,Media.MEDIA_PAUSED=3,Media.MEDIA_STOPPED=4,Media.MEDIA_MSG=["None","Starting","Running","Paused","Stopped"],MediaError=function(){this.code=null;this.message=""},MediaError.MEDIA_ERR_ABORTED=1,MediaError.MEDIA_ERR_NETWORK=
...
PhoneGap.hasResource("notification")||(PhoneGap.addResource("notification"),Notification=function(){},Notification.prototype.alert=function(a,b,c,d){var e=c;if(c==null||typeof c==="undefined")e="Alert";PhoneGap.exec(b,null,"com.phonegap.notification","alert",[a,{title:e,buttonLabel:d||"OK"}])},Notification.prototype.confirm=function(a,b,c,d){this.alert(a,b,c||"Confirm",d||"OK,Cancel")},Notification.prototype.blink=function(){},Notification.prototype.vibrate=function(){PhoneGap.exec(null,null,"com.phonegap.notification",
...
new Connection}));PhoneGap.hasResource("splashscreen")||(PhoneGap.addResource("splashscreen"),SplashScreen=function(){},SplashScreen.prototype.show=function(){PhoneGap.exec(null,null,"com.phonegap.splashscreen","show",[])},SplashScreen.prototype.hide=function(){PhoneGap.exec(null,null,"com.phonegap.splashscreen","hide",[])},PhoneGap.addConstructor(function(){if(typeof navigator.splashscreen=="undefined")navigator.splashscreen=new SplashScreen}));
if(void 0==SFHybridApp)var SFHybridApp={appStartTime:new Date,logToConsole:function(a){typeof debugMode!=="undefined"&&debugMode===true&&SFHybridApp.log("#console",a)},logError:function(a){SFHybridApp.log("#errors",a)},log:function(a,b){console.log("jslog: "+b)},buildLocalUrl:function(a){return navigator.device.platform=="Android"?SFHybridApp.buildAppUrl("file:///android_asset/www",a):a},buildAppUrl:function(a,b){var c=a.trim(),d=b.trim();if(c==="")return d;if(d==="")return c;c.charAt(c.length-1)===
"/"&&(c=c.substr(0,c.length-1));if(d===""||d==="/")return c+"/";d.charAt(0)!=="/"&&(d="/"+d);return c+d},loadUrl:function(a){navigator.device.platform=="Android"?navigator.app.loadUrl(a,{clearHistory:true}):location.href=a},deviceIsOnline:function(){var a;if(navigator&&navigator.network&&navigator.network.connection){a=navigator.network.connection.type;SFHybridApp.logToConsole("deviceIsOnline connType: "+a)}else SFHybridApp.logToConsole("deviceIsOnline connType is undefined.");return typeof a!=="undefined"?
a!=null&&a!=Connection.NONE&&a!=Connection.UNKNOWN:navigator.onLine},RemoteAppStartData:function(a,b,c){if(typeof a!=="string"||a.trim()==="")SFHybridApp.logError("appStartUrl cannot be empty");else{this.appStartUrl=a;this.isRemoteApp=true;this.isAbsoluteUrl=typeof b!=="boolean"?false:b;this.shouldAuthenticate=typeof c!=="boolean"?true:c}},LocalAppStartData:function(a,b){this.appStartUrl=typeof a!=="string"||a.trim()===""?"index.html":a;this.isAbsoluteUrl=this.isRemoteApp=false;this.shouldAuthenticate=
typeof b!=="boolean"?true:b}};
var SalesforceOAuthPlugin={getAuthCredentials:function(a,b){PhoneGap.exec(a,b,"com.salesforce.oauth","getAuthCredentials",[])},authenticate:function(a,b,c){PhoneGap.exec(a,b,"com.salesforce.oauth","authenticate",[JSON.stringify(c)])},logout:function(){PhoneGap.exec(null,null,"com.salesforce.oauth","logoutCurrentUser",[])},getAppHomeUrl:function(a){PhoneGap.exec(a,null,"com.salesforce.oauth","getAppHomeUrl",[])},getLoginDomain:function(a){PhoneGap.exec(a,null,"com.salesforce.oauth","getLoginDomain",
[])},setLoginDomain:function(a,b,c){PhoneGap.exec(a,b,"com.salesforce.oauth","setLoginDomain",[c])}};function OAuthProperties(a,b,c,d){this.remoteAccessConsumerKey=a;this.oauthRedirectURI=b;this.oauthScopes=c;this.autoRefreshOnForeground=d}
if(!PhoneGap.hasResource("smartstore")){PhoneGap.addResource("smartstore");var SmartStoreError=function(){this.code=null};SmartStoreError.UNKNOWN_ERROR=0;SmartStoreError.INVALID_ARGUMENT_ERROR=1;SmartStoreError.TIMEOUT_ERROR=2;SmartStoreError.PENDING_OPERATION_ERROR=3;SmartStoreError.IO_ERROR=4;SmartStoreError.NOT_SUPPORTED_ERROR=5;SmartStoreError.PERMISSION_DENIED_ERROR=20;var SoupIndexSpec=function(a,b){this.path=a;this.type=b},SoupQuerySpec=function(a){this.queryType="exact";this.indexPath=a;this.endKey=
this.beginKey=this.likeKey=this.matchKey=null;this.order="ascending";this.pageSize=10},PagedSoupCursor=function(){this.querySpec=this.cursorId=this.soupName=null;this.currentPageIndex=this.totalPages=this.pageSize=0;this.currentPageOrderedEntries=null},SmartStore=function(){SFHybridApp.logToConsole("new SmartStore");this.logLevel=0};SmartStore.prototype.buildAllQuerySpec=function(a,b,c){a=new SoupQuerySpec(a);a.queryType="range";if(b)a.order=b;if(c)a.pageSize=c;return a};SmartStore.prototype.buildExactQuerySpec=
function(a,b,c){a=new SoupQuerySpec(a);a.matchKey=b;if(c)a.pageSize=c;return a};SmartStore.prototype.buildRangeQuerySpec=function(a,b,c,d,e){a=new SoupQuerySpec(a);a.queryType="range";a.beginKey=b;a.endKey=c;if(d)a.order=d;if(e)a.pageSize=e;return a};SmartStore.prototype.buildLikeQuerySpec=function(a,b,c,d){a=new SoupQuerySpec(a);a.queryType="like";a.likeKey=b;if(c)a.order=c;if(d)a.pageSize=d;return a};SmartStore.prototype.registerSoup=function(a,b,c,d){SFHybridApp.logToConsole("SmartStore.registerSoup: '"+
a+"' indexSpecs: "+b);PhoneGap.exec(c,d,"com.salesforce.smartstore","pgRegisterSoup",[{soupName:a,indexes:b}])};SmartStore.prototype.removeSoup=function(a,b,c){SFHybridApp.logToConsole("SmartStore.removeSoup: "+a);PhoneGap.exec(b,c,"com.salesforce.smartstore","pgRemoveSoup",[{soupName:a}])};SmartStore.prototype.soupExists=function(a,b,c){SFHybridApp.logToConsole("SmartStore.soupExists: "+a);PhoneGap.exec(b,c,"com.salesforce.smartstore","pgSoupExists",[{soupName:a}])};SmartStore.prototype.querySoup=
function(a,b,c,d){SFHybridApp.logToConsole("SmartStore.querySoup: '"+a+"' indexPath: "+b.indexPath);PhoneGap.exec(c,d,"com.salesforce.smartstore","pgQuerySoup",[{soupName:a,querySpec:b}])};SmartStore.prototype.retrieveSoupEntries=function(a,b,c,d){this.logLevel>0&&SFHybridApp.logToConsole("SmartStore.retrieveSoupEntry: '"+a+"' entryIds: "+b);PhoneGap.exec(c,d,"com.salesforce.smartstore","pgRetrieveSoupEntries",[{soupName:a,entryIds:b}])};SmartStore.prototype.upsertSoupEntries=function(a,b,c,d){this.logLevel>
0&&SFHybridApp.logToConsole("SmartStore.upsertSoupEntries: '"+a+"' entries.length: "+b.length);PhoneGap.exec(c,d,"com.salesforce.smartstore","pgUpsertSoupEntries",[{soupName:a,entries:b}])};SmartStore.prototype.removeFromSoup=function(a,b,c,d){SFHybridApp.logToConsole("SmartStore.removeFromSoup: '"+a+"' entryIds: "+b);PhoneGap.exec(c,d,"com.salesforce.smartstore","pgRemoveFromSoup",[{soupName:a,entryIds:b}])};SmartStore.prototype.moveCursorToPageIndex=function(a,b,c,d){SFHybridApp.logToConsole("moveCursorToPageIndex: "+
a.cursorId+"  newPageIndex: "+b);PhoneGap.exec(c,d,"com.salesforce.smartstore","pgMoveCursorToPageIndex",[{cursorId:a.cursorId,index:b}])};SmartStore.prototype.moveCursorToNextPage=function(a,b,c){var d=a.currentPageIndex+1;d>=a.totalPages||this.moveCursorToPageIndex(a,d,b,c)};SmartStore.prototype.moveCursorToPreviousPage=function(a,b,c){var d=a.currentPageIndex-1;d<0||this.moveCursorToPageIndex(a,d,b,c)};SmartStore.prototype.closeCursor=function(a,b,c){SFHybridApp.logToConsole("closeCursor: "+a.cursorId);
PhoneGap.exec(b,c,"com.salesforce.smartstore","pgCloseCursor",[{cursorId:a.cursorId}])};PhoneGap.addConstructor(function(){SFHybridApp.logToConsole("SmartStore pre-install");if(typeof navigator.smartstore==="undefined"){SFHybridApp.logToConsole("SmartStore.install");navigator.smartstore=new SmartStore}})};
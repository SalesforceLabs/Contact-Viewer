...
if(void 0==SFHybridApp)var SFHybridApp={appStartTime:new Date,logToConsole:function(a){"undefined"!==typeof debugMode&&!0===debugMode&&SFHybridApp.log("#console",a)},logError:function(a){SFHybridApp.log("#errors",a)},log:function(a,c){console.log("jslog: "+c)},buildLocalUrl:function(a){return"Android"==navigator.device.platform?SFHybridApp.buildAppUrl("file:///android_asset/www",a):a},buildAppUrl:function(a,c){var b=a.trim(),d=c.trim();if(""===b)return d;if(""===d)return b;"/"===b.charAt(b.length-
1)&&(b=b.substr(0,b.length-1));if(""===d||"/"===d)return b+"/";"/"!==d.charAt(0)&&(d="/"+d);return b+d},loadUrl:function(a){"Android"==navigator.device.platform?navigator.app.loadUrl(a,{clearHistory:!0}):location.href=a},deviceIsOnline:function(){var a;navigator&&navigator.network&&navigator.network.connection?(a=navigator.network.connection.type,SFHybridApp.logToConsole("deviceIsOnline connType: "+a)):SFHybridApp.logToConsole("deviceIsOnline connType is undefined.");return"undefined"!==typeof a?
null!=a&&a!=Connection.NONE&&a!=Connection.UNKNOWN:navigator.onLine},RemoteAppStartData:function(a,c,b){"string"!==typeof a||""===a.trim()?SFHybridApp.logError("appStartUrl cannot be empty"):(this.appStartUrl=a,this.isRemoteApp=!0,this.isAbsoluteUrl="boolean"!==typeof c?!1:c,this.shouldAuthenticate="boolean"!==typeof b?!0:b)},LocalAppStartData:function(a,c){this.appStartUrl="string"!==typeof a||""===a.trim()?"index.html":a;this.isAbsoluteUrl=this.isRemoteApp=!1;this.shouldAuthenticate="boolean"!==
typeof c?!0:c}};
...
[])},setLoginDomain:function(a,b,c){PhoneGap.exec(a,b,"com.salesforce.oauth","setLoginDomain",[c])}};function OAuthProperties(a,b,c,d,e){this.remoteAccessConsumerKey=a;this.oauthRedirectURI=b;this.oauthScopes=c;this.autoRefreshOnForeground=d;this.autoRefreshPeriodically=e};
